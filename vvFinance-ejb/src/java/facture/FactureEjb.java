...
public interface FactureEjb {
    ...
    public SCatService[] findSCatService(String idSCatService, String nomSCat, String cat, String periodeFacturation, Connection conn) throws Exception, RemoteException;
    ...
    public int annulationFactureClient(String idFactureClient, String user) throws Exception;
