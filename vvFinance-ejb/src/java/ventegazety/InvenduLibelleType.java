...
public class InvenduLibelleType extends ClassMAPTable{
  ...
  public InvenduLibelleType() {
    setNomTable("INVENDULIBTYPE");
  }
 ...
 public String getTuppleID() {
  ...
  public static double getAllSommeMontant(InvenduLibelleType[] l){
