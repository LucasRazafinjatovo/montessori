...
public class Invendu extends ClassMAPTable{
  public Invendu(){
    super.setNomTable("invendu");
  }
  public Invendu(String dat, String nbrinv, String prise, String remarque) throws Exception
  {
    super.setNomTable("invendu");
    this.preparePk("INV","getSeqInvendu");
    //this.preparePk("IVE","getSeqInvendu");//ankorondrano
    this.setId(makePK());
  ...
  public Invendu(String dat, String nbrinv, String prise, String remarque, Connection c) throws Exception
  {
    super.setNomTable("invendu");
    this.preparePk("INV","getSeqInvendu");
    this.setDaty(utilitaire.Utilitaire.string_date("dd/MM/yyyy",dat));
