...
public class LigneCreditRecetteComplet extends ClassMAPTable {
  ...
  public double reste;
	...
	public LigneCreditRecetteComplet(){
		this.setNomTable("LigneCreditRecetteComplet");
	}

	public LigneCreditRecetteComplet(String idLigne, String designation,
