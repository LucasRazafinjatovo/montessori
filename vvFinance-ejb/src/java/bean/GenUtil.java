...
public abstract class GenUtil implements java.io.Serializable {
  ...
  *@Elle ne sera valide que si la clé est un String
     */
    ...
    public Object[] rechercher(int numChamp, Object valeur, Connection c) throws Exception {
        ...
        try {
            ...
            if ((type.compareToIgnoreCase("Varchar2") == 0) || (type.compareToIgnoreCase("char") == 0)) {
                ...
                st.setString(1, (String) valeur);
                //System.out.println(st.toString() + " 1111 ========== " + param + valeur + "type" + type);
            }
            if ((type.compareToIgnoreCase("Number") == 0) || (type.compareToIgnoreCase("Counter") == 0)) {
            ...
            s.printStackTrace();
            //System.out.println("RechercheExecution par Reference " + s.getMessage());
  ...
  *@ Methode permettant de gerer les objets envoyés en fonction du num de Page
    ...
    /*
  *@ Methode permettant de gerer les objets envoyés en fonction du num de Page
  *@numChampDaty et daty représentent les intervalles
     */
    public Object[] rechercher(int[] numChamp, Object[] valeur, String apresWhere, Connection c, int numChampDaty[], String daty[], int numPage) {
        ...
        try {
            ...
            System.out.println("Erreur dans Recherche multicritère rechercher(int[] numChamp,Object[] valeur,String apresWhere,Connection c,int numChampDaty[],String daty[],int numPage " + s.getMessage());
            return null;
        } finally {
            try {
                if (rs != null) {
    ...
    /* public Object[] rechercher(int[] numChamp,Object[] valeur,String apresWhere,int numChampDaty[],String daty[],int numPage)
  {
    ...
    ResultSet rs = null;
    Connection c=null;
    int indiceInf=(Parametre.getNbParPage()*(numPage-1))+1;
    int indiceSup=Parametre.getNbParPage()*(numPage);
    try
    {
      util = new UtilDB();
      c = util.GetConn();
      System.out.println("LISTE CHAMP "+getListeChampPage());
      String param="select * from (select "+getListeChampPage()+",rowNum as r from (select * from " + getNomTable() + " where "+makeWhere(numChamp,valeur)+" "+makeWhereIntervalle(numChampDaty,daty)+" "+apresWhere+")) where r between "+indiceInf+" and "+indiceSup;
  ...
  //if(type.compareToIgnoreCase("Datetime")==0)
    ...
    {
      s.printStackTrace();
      System.out.println("Erreur dans Recherche multicritère 3" + s.getMessage());
      return null;
    }
    finally
    {
  ...
  *@Methode qui permet de faire une recherche multi-critere sur une table
  *@numChamp[] donne une liste de numero de champ et valeur[] donne
  *@une liste de valeur. apresWhere est utilisé s'il y a une syntaxe SQL
  *@après le mot where ex:group by
     */
    ...
    public Object[] rechercherVect(int[] numChamp, Object[] valeur, String apresWhere) throws Exception {
        ...
        try {
            ...
            System.out.println("Erreur dans Recherche multicritère 2" + s.getMessage());
            throw new Exception(s.getMessage());
        } finally {
            try {
                if (c != null) {
  ...
  {
      ResultSet rs = this.rechercherResult(numChamp,valeur,apresWhere,c);
      System.out.println("TAFIDITRA 2"+rs.getMetaData().getColumnCount());
      return resultatGen(rs);
  }*/
    ...
    public Object[] rechercher(int[] numChamp, Object[] valeur, String apresWhere, java.sql.Connection c) throws Exception {
        ...
        try {
            ...
            s.printStackTrace();
            //System.out.println("Erreur dans Recherche multicritère 1" + s.getMessage());
            throw new Exception(s.getMessage());
        } finally {
            try {
                if (rs != null) {
    ...
    public int calculNombreLigne(int[] numChamp, Object[] valeur, String apresWhere, java.sql.Connection c) throws Exception {
        ...
        try {
            ...
            System.out.println("Erreur dans Recherche multicritère " + s.getMessage());
            throw new Exception(s.getMessage());
        } finally {
            try {
                if (rs != null) {
  ...
  *@Methode qui permet d'avoir le mot where qu'on va utiliser dans la requete complexe
    ...
    //public abstract  Object[] resultatGen(ResultSet rs);
/*  public Object[] resultatTotale(ResultSet rs)
  {
    try
    {
      int i = 0;
      int k = 0;
      Object temp = null;
      Class izy= Class.forName(this.getNomClasse());
      Vector vect = new Vector();
      while(rs.next())
      {
        temp = izy.getConstructor(null).newInstance(null);
        for(int c=0;c<champ.length;c++)
        {
          String nomMethode="set"+Utilitaire.convertDebutMajuscule(champ[c].getNomColonne());
          Class x=Class.forName(champ[c].typeJava);
          Class[] paramT={x};
          String[] args={rs.getString(c)};
          //this.getClass().getMethod(nomMethode,paramT).invoke(this,args);
          temp.getClass().getMethod(nomMethode,paramT).invoke(temp,args);
        }
        vect.add(i, temp);
        i++;
      }
    ...
    public double[] calculSommeNombre(int[] numChamp, Object[] valeur, String apresWhere, int numChampDaty[], String daty[], String[] nomColSomme) throws Exception {
        ...
        try {
            ...
            System.out.println("Erreur dans calculSommeNombre multicritère 1" + s.getMessage());
            throw new Exception(s.getMessage());
        } finally {
            try {
                if (c != null) {
   ...
   Retourne la liste des sommes à calculer et le nombre de ligne total à la fin
    ...
    public Object[] rechercher(int[] numChamp, Object[] valeur, String apresWhere, java.sql.Connection c, int numChampDaty[], String daty[]) throws Exception {
        ...
        try {
            ...
            //System.out.println("commande interne:"+param);
            st = preparerStatement(param, numChamp, valeur, c);
            rs = st.executeQuery();
            return resultatGen(rs);
        } catch (SQLException s) {
