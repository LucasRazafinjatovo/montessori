...
public class UnionIntraTable extends ClassMAPTable {
  ...
  public UnionIntraTable(String nomTable,String id1e,String id2e,String remarqueE, String montantE, String seq){
    this.setNomTable(nomTable);
    this.setId1(id1e);
    this.setId2(id2e);
    this.setRemarque(remarqueE);
  ...
  public UnionIntraTable(Connection c,String nomTable,String nomProcedure,String suff,String id1e,String id2e,String remarqueE, double montantE,int eta) throws Exception{
    setNomTable(nomTable);
    setNomProcedureSequence(nomProcedure);
    setIndicePk(suff);
    id = makePK(c);
  ...
  public static String updateMontantMere(String nomTable,String id1,String id2,String montant,java.sql.Connection c) throws Exception
  {
    ...
    try {
      ...
      UnionIntraTable[] ui=(UnionIntraTable[])uti.rechercher(2,id1,c);
  ...
  public static String updateMontantMerePrev(String nomTable,String id1,String id2,String montant,java.sql.Connection c) throws Exception
  {
    Statement st= null;
    try {
      UnionIntraTableUtil uti=new UnionIntraTableUtil();
      ...
      // if((ui.length>0)&&(ui[0].estIlModifiable()==false)) throw new Exception("Mappage deja valide");
      String rek = "update "+nomTable+"  set montantMere="+ montant+" where id1='"+id1+"' and id='"+id2+"'";
      st = c.createStatement();
      st.executeUpdate(rek);
      return id1;
    }
