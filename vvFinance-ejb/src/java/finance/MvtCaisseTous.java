...
public class MvtCaisseTous extends ClassMAPTable{
  ...
  public MvtCaisseTous() {
    super.setNomTable("mvtcaissetous");
  }
 /* public MvtCaisseTous(String id,String idmvt,String idor) {
