...
public class MvtCaisse extends ClassMAPTable {
  ...
  public MvtCaisse(String daty,String datyValeur,String designation,String debit,String credit,String idDevise,String idmodepaiement,String idCaisse,String remarque,String agence,String tiers,String numpiece,String typ,String idOrdre)
  {
  ...
  public MvtCaisse(String id,String daty,String datyValeur,String designation,String debit,String credit,String idDevise,String idmodepaiement,String idCaisse,String remarque,String agence,String tiers,String numpiece,String typ,String idOrdre)
  {
    setNomTable("mvtCaisse");
    setDaty(Utilitaire.string_date("dd/MM/yyyy",daty));
    this.setDatyValeur(Utilitaire.string_date("dd/MM/yyyy",datyValeur));
   ...
   public MvtCaisse(String id,String daty,String datyValeur,String designation,String debit,String credit,String idDevise,String idmodepaiement,String idCaisse,String remarque,String agence,String tiers,String numpiece,String typ,String idOrdre,String idmvtor)
      {
        setDaty(Utilitaire.string_date("dd/MM/yyyy",daty));
        setDesignation(designation);
        setCredit(Utilitaire.stringToDouble(credit));
...
public void setIdecole(String idecole) {
  ...
  public void construirePK(Connection c) throws Exception {
    super.setNomTable("mvtcaisse");
    this.preparePk("MC", "getSeqMvtCaisse");
    this.setId(makePK(c));
}
