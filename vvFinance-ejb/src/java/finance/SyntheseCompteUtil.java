...
public class SyntheseCompteUtil extends GenUtil {

  public SyntheseCompteUtil() {
    super("EntreeCompValCatgroup","finance.SyntheseCompte");
  }
  ...
  public Object[] resultatGen(ResultSet rs) {
    try
    {
            ...
            while(rs.next())
            {
                temp = new SyntheseCompte (rs.getDate(1),rs.getDouble(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6));
                    vect.add(i,temp);
                    i++;
            }
