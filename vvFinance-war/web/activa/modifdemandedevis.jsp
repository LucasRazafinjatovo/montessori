...
atcl.setIdDevis(request.getParameter("idDevis"));
...
%>
 ...
 <input name="bute" type="hidden" id="bute" value="activa/fichedemandedevis.jsp&idDevis=<%=request.getParameter("idDevis")%>">
