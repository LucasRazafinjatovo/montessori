                ...
                <tr>
                  <td class="Style1"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <td bgcolor="#ffffff"><table cellspacing="0" cellpadding="0" border="0" align="center" width="120">
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=ventegazety/saisivendeur.jsp" class="menu">Saisir vendeur</a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=ventegazety/saisiprise.jsp" class="menu">Saisir prise </a>                      
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=ventegazety/listePrise.jsp" class="menu">Liste prise</a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=ventegazety/saisinvendu.jsp" class="menu">Saisie invendu</a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=ventegazety/listeInvendu.jsp" class="menu">Liste invendu </a>                      
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=ventegazety/saisirecette.jsp" class="menu">Saisir recette</a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=ventegazety/listeRecette.jsp" class="menu">Liste recette </a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=ventegazety/OrRecette.jsp" class="menu">OR via Liste recette </a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=ventegazety/rechercheVente.jsp" class="menu">Etat de vente</a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=ventegazety/etatVenteGroupe.jsp" class="menu">Etat de vente groupe</a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=ventegazety/calculCommissionGroupe.jsp" class="menu">Commission groupe </a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=ventegazety/listeVendeur.jsp" class="menu">Liste des vendeurs</a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=ventegazety/saisiVendeurPrixJournal.jsp" class="menu">Prix indiv</a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=ventegazety/listePrixJournalV.jsp" class="menu">Liste Prix indiv</a></td>
                        </tr>
                      </table></td>
                      <td bgcolor="#FFFFFF"></td>
                    </tr>
                ...
                <tr>
                  <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="15"><img src="images/right.gif" alt="" width="15" height="25"></td>
                    </tr>
                    <tr>
                      <td colspan="3" bgcolor="#ffffff"><table cellspacing="0" cellpadding="0" border="0" align="center" width="120">
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp; <a href="<%=lien%>?but=facture/factureInit.jsp&acte=-" class="menu">Nouvelle</a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=facture/critereFactureAnalyse.jsp" class="menu">Analyser </a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=facture/critereFacture.jsp" class="menu">Lister </a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        </tr>
                        <!--<tr>
                      <td><img src="images/puce.gif" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=facture/listeHistoriqueFacture.jsp" class="menu">Lister
                        ...
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=facture/client.jsp" class="menu">Enregistrer client</a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=facture/listeClient.jsp" class="menu">Lister client </a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=facturefournisseur/critereEntreFactureOr.jsp" class="menu">Lister Facture C </a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=facturefournisseur/critereEntreFactureOrSansLc.jsp" class="menu">Etat Facture C </a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=facturefournisseur/listeFactureFChoixRct.jsp" class="menu">Attacher Fact Client </a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=facturefournisseur/listeFactureClientGroupe.jsp" class="menu">Groupe Facture C </a></td>
                        </tr>
                      </table></td>
                    </tr>
                    <tr>
                  ...
                  <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td colspan="3" bgcolor="#ffffff" align="center"><table cellspacing="0" cellpadding="0" border="0" align="center" width="120">
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp; <a href="<%=lien%>?but=finance/billetage.jsp" class="menu">Billetage</a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=ded/ordonnerRecette.jsp" class="menu">Editer OR / facture C </a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp; <a href="<%=lien%>?but=ded/ordonnerRecetteNormale.jsp" class="menu">Editer OR </a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp; <a href="<%=lien%>?but=ded/listeOR_o.jsp" class="menu">Liste OR </a></td>
                        </tr>
                        <tr>
                          <td><img src="images/puce.gif" alt="" width="11" height="11">&nbsp; <a href="<%=lien%>?but=ded/listeOR.jsp" class="menu">Groupe OR </a></td>
                        </tr>
                        >
                      </table></td>
                    </tr>
