        ...
        <tr>
            <td> <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="monographe">
                    ...
                    <tr>
                        ...
                        <td align="center"><textarea name="remarque" class="champ" style="width: 200px; height: 100px;" id="remarque" maxlength="100">
   Salaire - <%=emp.substring(2, emp.length())%> - Mois de <%=Utilitaire.datedujourlettre(Utilitaire.dateDuJour())%></textarea></td>
                        <td align="center">&nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle"> </td>
                    </tr>
                    <tr>
                        <td class="left">Montant : </td>
                        <td align="center"><input type="text" class="champ" id="montantTTC" readonly value="<%=Utilitaire.stringToDouble(request.getParameter("montant"))%>"/>
                            <input name="montantTTC" type="hidden" class="champ" id="montantTTC" value="<%=Utilitaire.stringToDouble(request.getParameter("montant"))%>"/></td>
                        <td align="center">&nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle">            </td>
                    </tr>
                    <tr>
                ...
                <table width="75%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="center"><input name="nature" type="hidden" id="nature" value="<%=nature%>">
                            ...
                            <input name="acte" type="hidden" id="acte" value="INSERTSAL">
                            <input name="avecOp" type="hidden" id="acte" value="ok">
                            <input name="employe" type="hidden" id="employe" value="<%=emp%>">
                            <input name="idsolde" type="hidden" value="<%=request.getParameter("idsolde")%>">
