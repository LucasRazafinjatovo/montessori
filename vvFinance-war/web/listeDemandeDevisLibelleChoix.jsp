...
e.setNomTable("demandedevisarticleviser");
...
<form action="listeDemandeDevisLibelleChoix.jsp?champReturn=<%=request.getParameter("champReturn")%>" method="post" name="listedemandedevisvisachoix" id="listedemandedevisvisachoix">
<%
