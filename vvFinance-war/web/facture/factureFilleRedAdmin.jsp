...
refObj=request.getParameter("refObj");
try{
	...
	if(action == null || action.compareTo("red")==0){
		...
		u.createFactureFille(request.getParameter("idFactMere"),refObj,designation,qte,request.getParameter("idUnite"),pu,reductionF);
		ff=u.findFactureFille("%","%","%",idFactMere);
	}
...
<form action="<%=lien%>?but=facture/apresFactureFinal.jsp" method="post" name="factFille" id="factFille">
  ...
  <tr>
	...
	<table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="formadd">
        <tr>
          ...
          <td width="254" valign="top">&nbsp; <input name="daty" type="text" class="champ" id="date" value="<%=Utilitaire.formatterDaty(fm.getDaty())%>" size="10" maxlength="10">
        ...
        <tr>
          <td width="144" height="23" valign="top" class="left">Date d&eacute;but
            :</td>
          <td width="254" valign="top">&nbsp; <input name="periodeDebut" type="text" class="champ" id="date" value="<%=Utilitaire.formatterDaty(fm.getPeriodeDebut())%>" size="10" maxlength="10">
        ...
        <tr>
          ...
          <td width="254" valign="top">&nbsp; <input name="periodeFin" type="text" class="champ" id="date" value="<%=Utilitaire.formatterDaty(fm.getPeriodeFin())%>" size="10" maxlength="10">
        ...
        <tr>
          ...
          <td valign="top">&nbsp; <textarea cols="40" rows="5" name="noteExplicative"><%=fm.getNoteExplicative()%></textarea></td>
        </tr>
        <tr>
 ...
 <table width="450" border="0" align="center" cellpadding="0" cellspacing="0" class="monographe">
  ...
  <td><input name="reductionF" type="text" id="reductionF" value="0" size="5" maxlength="3"  width="50"></td>
  </tr>
  ...
  <input name="refObj" type="hidden" value="<%=refObj%>">
  <br>
<div align="center">
...
%>
     ...
     <tr>
          ...
          <td width="26" align="center" valign="middle"><a href="<%=lien%>?but=facture/apresFactureFille.jsp&idTypeFacture=<%=refObj%>&idFactMere=<%=idFactMere%>&idFF=<%=ff[i].getIdFactureFille()%>&acte=DELETE&type=ADMIN"><img src="images/button_drop.png" width="11" height="13" border="0" alt="Supprimer"></a></td>
