...
%>
        <tr>
          <td width="160" cellpadding="5" cellspacing="2"><%=ff[i].getDesignation()%> </td>
          <td width="71" align="right" cellpadding="5" cellspacing="2"><div align="center"><font color="15"><%=Utilitaire.formaterAr((double)ff[i].getPrixUnitaire())%></font></div></td>
          <td width="66" align="center" cellpadding="" cellspacing="2"><font color="15"><%=ff[i].getQuantite()%></font></td>
          <td width="68" align="center" cellpadding="5" cellspacing="2"><%=u.findTypeObjet("unite",ff[i].getIdUnite(),"%")[0].getVal()%></td>
          <td align="center" width="33" cellpadding="5" cellspacing="2"><%=ff[i].getReduction()%></td>
          <td width="127" align="right" cellpadding="5" cellspacing="2"><font color="15"><%=Utilitaire.formaterAr((double)(ff[i].getMontant()))%><%=deviseEn.getVal()%></font></td>
        </tr>
        <%
}
  %>
