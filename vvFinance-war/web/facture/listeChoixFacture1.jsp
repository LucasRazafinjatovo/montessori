...
fm = u.findFactureMere(datyinf,datySup,numFact,client,"","eta4",idCatServ,idSsCatServ);
}catch(Exception e){
%>
...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="monographe">
          ...
          <tr>
            ...
            <td><input name="numFact" type="text" class="champ" id="numFact"> </td>
          </tr>
        </table>
...
<br>
<br>
 <form action="<%=lien%>?but=facture/avoir.jsp" method="post">
