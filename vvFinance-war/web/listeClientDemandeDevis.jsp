...
<form action="listeClientDemandeDevis.jsp?champReturn=<%=request.getParameter("champReturn")%>" method="post" name="listedemandedevischoix" id="listedemandedevischoix">
<%
...
%>
<br>
<form action="<%=pr.getLien() %>?but=apresChoixClientDemandeDevis1.jsp" method="post" name="frmchx" id="frmchx">
