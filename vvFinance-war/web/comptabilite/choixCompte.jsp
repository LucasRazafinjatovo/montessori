...
cltCrt.setNomTable("comptecomptabilite_libelle");
...
<%if(pazy!=1){%>
         <a href="choixCompte.jsp?id=<%=Utilitaire.remplacePourcentage(id)%>&val=<%=Utilitaire.remplacePourcentage(val)%>&desce=<%=Utilitaire.remplacePourcentage(desce)%>&pazy=<%=pazy-1%>">&lt;&lt;Page
