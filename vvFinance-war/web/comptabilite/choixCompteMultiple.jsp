...
<form action="choixCompteMultiple.jsp" method="post">
...
<%if(pazy!=1){%>
         <a href="choixCompteMultiple.jsp?id=<%=Utilitaire.remplacePourcentage(id)%>&val=<%=Utilitaire.remplacePourcentage(val)%>&desce=<%=Utilitaire.remplacePourcentage(desce)%>&pazy=<%=pazy-1%>">&lt;&lt;Page
