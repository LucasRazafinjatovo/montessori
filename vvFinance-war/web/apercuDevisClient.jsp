...
<title>Apercu Facture pro format </title>
    ...
    <td height="288">
      <table width="560" height="200" border="1" align="center" cellpadding="0" cellspacing="0">
        <tr class="headFact">
          ...
          <td width="100" align="center"><strong>code recto verso</strong></td>
          <td width="100" align="center"><strong>Nombre article</strong></td>
          <td width="100" align="center"><strong¨>Cout unitaire impression</strong></td>
          <td width="75" align="center"><strong>date du devis</strong></td>
           ...
           // float test=(float)((dd[0].getCout()*dd[0].getNombreimpression())/dd[0].getNombre())f;
            double xx=(dd[0].getCout()*dd[0].getNombreimpression())/dd[0].getNombre();
%>
                 <tr>
           <td width="200" height="20" style="border-bottom:none; border-top:none" valign="top"><%=dd[0].getDesignation()%></td>
           <td width="100"  align="center" valign="top" style="border-bottom:none; border-top:none"><%=dd[0].getCoderv()%></td>
           <td width="100" align="center" valign="top" style="border-bottom:none; border-top:none"><%=dd[0].getNombre()%></td>
           <td width="100" align="center" valign="top" style="border-bottom:none; border-top:none"><%= Utilitaire.arrondir(xx,2) %> Ar</td>
     ...
     <table width="560" align="center" cellpadding="0" cellspacing="0">
          <% double w1=dd[0].getCout()*dd[0].getNombreimpression();
           ...
           %>
        <tr>
          <td><strong> Montant sans reduction : </strong><%=w1%> &nbsp; Ariary</td>
        </tr>
        <tr>
          <td><strong> Montant reduction : </strong><%=(w1*dd[0].getRemise())/100 %> &nbsp; Ariary</td>
          <td><strong> Remise : </strong><%= dd[0].getRemise() %> %</td>
        </tr>
        <tr>
          <td><strong>Montant HTVA : </strong><%=w2%> &nbsp; Ariary</td>
        </tr>
        <tr>
            <td><strong> TVA 20% : </strong><%=((w2*20)/100)%> &nbsp; Ariary</td>
       </tr>
        <tr>
            <td><strong> Total TTC: </strong><%=w2+((w2*20)/100)%> &nbsp; Ariary</td>
       </tr>
      </table></td>
  </tr>
</table>
