...
<%!
  String apres="facturefournisseur/critereEntreFactureOr.jsp";
  String lien= null;
  UserEJB u = null;
TypeObjet ag[] =null;
 ...
 idLC=request.getParameter("idLC");if ((idLC==null)||idLC.compareTo("")==0) idLC="%";
  ...
  table = request.getParameter("table");if ((table==null)||table.compareTo("")==0) table="factureclientorgroupe";
    ...
    //findFactureFournisseurPageLc(String nomtable, String id, String fourn, String designation, String numFact, String idLigne, String daty1, String daty2, String desiLc, String mois1Lc, String mois2Lc, String anneeLc, String dirLc, String entiteLc, String typeLc, String compteLc, int numPage)
                        ...
                        crt.setNumcompte(request.getParameter("agence"));
        ...
        <tr>
          ...
          <td align="center"><div align="left">
            <select name="table" class="champ" id="select2">
                ...
                <option value="fcorgroupepaye" <%if(table.compareTo("fcorgroupepaye")==0) out.println("selected");%>>paye</option>
                <option value="fcorgroupeImpaye" <%if(table.compareTo("fcorgroupeImpaye")==0) out.println("selected");%>>Impaye</option>
            </select>
          </div></td>
...
%>
                <option value="<%=ag[i].getVal()%>" <%if(ag[i].getVal().compareTo(Utilitaire.remplacerNull(request.getParameter("agence")))==0) out.println("selected");%>><%=ag[i].getVal()%></option>
                <%
}
%>
              </select></td>
 ...
 <td width="10%" align="center" valign="top">Reste </td>
  ...
  %>
        <tr onmouseover="this.style.backgroundColor='#EAEAEA'" onmouseout="this.style.backgroundColor=''">
          ...
          <td align="right"><a href="<%=lien%>?but=ded/listeOR.jsp&ded_id=<%=factF[i].getIdFactureFournisseur()%>"><%=utilitR.formaterAr(factF[i].getOpmontant())%> </a> </td>
