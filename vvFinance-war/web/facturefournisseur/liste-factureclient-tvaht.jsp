...
<%
    ...
    e.setNomTable("FACTURECLIENTTVAHT");
    ...
    pr.setApres("facturefournisseur/liste-factureclient-tvaht.jsp");
...
%>
    <h1>Liste facture client</h1>
    <form action="<%=pr.getLien()%>?but=facturefournisseur/liste-factureclient-tvaht.jsp" method="post" name="personneliste" id="personneliste">
