...
<%!
  String apres="facturefournisseur/critereEntreFacture.jsp";
  String lien= null;
  UserEJB u = null;
 ...
 idLC=request.getParameter("idLC");if ((idLC==null)||idLC.compareTo("")==0) idLC="%";
  ...
  idType=request.getParameter("idType");if ((idType==null)||idType.compareTo("")==0) idType="";
    ...
    //findFactureFournisseurPageLc(String nomtable, String id, String fourn, String designation, String numFact, String idLigne, String daty1, String daty2, String desiLc, String mois1Lc, String mois2Lc, String anneeLc, String dirLc, String entiteLc, String typeLc, String compteLc, int numPage)
                         factRctRs = u.findFactureFournisseurPageLc("factureflcvue",  request.getParameter("num"),request.getParameter("fournisseur"),request.getParameter("designation"),request.getParameter("idFact"),request.getParameter("numLc"),  dateDebut,  dateFin, request.getParameter("desiLc"),mois1,mois2,annee,direction,entite,idType,numCompte , pazy,colonne,ordre);
...
%>
        ...
        <tr>
          ...
          <td align="center"><div align="left">
            <input name="numLc" type="text" class="champ"   id="numLc" value="<%=numLc%>" size="10" maxlength="10" />
          </div></td>
...
&nbsp; <a href="javascript:cal2.popup()"><img src="calendar/img/cal.gif" alt="Cliquez ici pour choisir une date" width=16 height=16 border=0 align="absmiddle" /></a> </div></td>
        ...
        <tr>
          ...
          <td align="center"><div align="left">
  <input name="fournisseur" type="text" class="champ"   id="fournisseur" value="<%=Utilitaire.remplacerNull(fournisseur)%>"size="10" />
...
&nbsp; <img src="images/blank.gif" width="16" height="16" align="absmiddle" /> </div></td>
        ...
        <tr>
          ...
          <td align="center"><div align="left">
  <input name="designation" type="text" class="champ"   id="designation" value="<%=Utilitaire.remplacerNull(designation)%>" />
&nbsp; <img src="images/blank.gif" width="16" height="16" align="absmiddle" /> </div></td>
          <td class="left">Numero </td>
          <td align="center"><div align="left">
            <input name="num" type="text" class="champ"   id="num" value="<%=Utilitaire.remplacerNull(num)%>"size="10" />
          </div></td>
        </tr>
        <tr>
