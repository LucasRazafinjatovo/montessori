...
<%!
  String apres="facturefournisseur/listeFactureRecetteAviser.jsp";
  String nomFichier="facturefournisseur/listeFactureRecetteAviser.jsp";
  String lien= null;
  UserEJB u = null;
  TypeObjet dev[] = null;
  Caisse caiss[] = null;
...
<%
  ...
  nomCol=Utilitaire.getNomColonne(new FactureFournisseur());
                ...
                //factF = u.findFactureF("%", "", "", "%", "%","%", "idFactureFournisseur", "ASC", "");
                         ...
                         ResultatEtSomme rs= u.findFactureFournisseurPage("FACTURECLIENTAVISE",idFact,  dateDebut,  dateFin, fournisseur, designation, colonne, ordre, apresW,pazy);
  ...
  <tr>
    <td> <p align="center"><strong><u>RECAPITULATION RECHERCHE</u></strong></p>
      ...
      <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="monographe">
        <tr class="head">
          <td width="61" align="center" valign="top">num</td>

          <td width="48" align="center" valign="top">Date</td>
                   <td width="91" align="right" valign="top"><div align="center">Designation</div></td>
          <td width="111" align="right" valign="top"><div align="center">Fournisseur</div></td>
          <td width="117" align="right" valign="top"><div align="center"><strong>Montant TTC</strong></div></td>

          <td width="58" align="center" valign="top">Montant Tva</td>
        </tr>
        <%
  for(int i=0;i<factF.length;i++){
  %>
        <tr onmouseover="this.style.backgroundColor='#EAEAEA'" onmouseout="this.style.backgroundColor=''">
          <td align="center"><a href="<%=lien%>?but=facturefournisseur/viserFactureRecette.jsp&numObjet=<%=factF[i].getTuppleID()%>&nature=<%=Constante.objetFactureFournisseur%>"><%=factF[i].getTuppleID()%></a></td>
