...
<%!
  String apres="facturefournisseur/listeFactureFChoixRct.jsp";
  String nomFichier="facturefournisseur/listeFactureFChoixRct.jsp";
  String lien= null;
  UserEJB u = null;
  TypeObjet dev[] = null;
  Caisse caiss[] = null;
...
<%
  ...
  nomCol=Utilitaire.getNomColonne(new FactureFournisseur());
                ...
                //factF = u.findFactureF("%", "", "", "%", "%","%", "idFactureFournisseur", "ASC", "");
                         ...
                         ResultatEtSomme rs= u.findFactureFournisseurPage("FACTURECLIENTAMAPPERLCVue",idFact,  dateDebut,  dateFin, fournisseur, designation, colonne, ordre, apresW,pazy);
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="600">
  <tr>
    <td> <p align="center"><strong><u>RECAPITULATION RECHERCHE</u></strong></p>
      ...
      <form action="<%=lien%>?but=lc/listeLcChoix.jsp" method="post">

     <input name="typeObjet" type="hidden" value="<%=Constante.getObjetFacture()%>">
  ...
  %>
        <tr onmouseover="this.style.backgroundColor='#EAEAEA'" onmouseout="this.style.backgroundColor=''">
          <td align="center"><a href="<%=lien%>?but=lc/listeLcRecetteChoix.jsp&numObjet=<%=factF[i].getTuppleID()%>&indice=<%=i%>&numObjet<%=i%>=<%=factF[i].getIdFactureFournisseur()%>&montantObjet<%=i%>=<%=factF[i].getMontantTTC()%>"><%=factF[i].getTuppleID()%></td>
...
<input type="hidden" name="montantObjet<%=i%>" value="<%=factF[i].getMontantTTC()%>">
  ...
  %>
     ...
     <div align="center">
       <input name="bouton" type="hidden" value="choix">
     </div>
      </form></td>
</tr>
</table>
