...
pr.setApres("facturefournisseur/listeFactureFournisseurGroupe.jsp");
...
%>
<h1>Liste des factures fournisseurs groupe</h1>
<form action="<%=pr.getLien()%>?but=facturefournisseur/listeFactureFournisseurGroupe.jsp" method="post" name="listePub" id="listePub">
<%
...
etat : <select name="etat" class="champ" id="etat" >
              ...
              <option value="ffopgroupevise"  <%if(etat.compareTo("ffopgroupevise")==0) out.println("selected");%>>vise</option>
              <option value="ffopgroupenonvise"  <%if(etat.compareTo("ffopgroupenonvise")==0) out.println("selected");%>>non vise</option>
       </select>
