...
<%!
    String apres="facturefournisseur/critereEntreFactureOrSansLc.jsp";
    String lien= null;
    UserEJB u = null;
    TypeObjet ag[] =null;
    ...
    String colonne,ordre,table="factureClientorSansLc";
    String devise=null;
    int pazy=1;
    int nbPage=0;
    int nbParPazy=10;
...
<%
    ...
    try{
        ...
        ag = u.findTypeObjet("Agence","%","%"); //Liste agence
        ...
        if((tempDir!=null)&&(tempDir.compareToIgnoreCase("")!=0)&&(tempDir.compareToIgnoreCase("D Communication")!=0)){
            direction=tempDir;
        }
        ...
        table = request.getParameter("table");if ((table==null)||table.compareTo("")==0) table="factureClientorSansLc";
        ...
        crt.setRemarque(request.getParameter("agence"));
        System.out.println("AGENCE : "+request.getParameter("agence")+" direction = "+direction);
        ...
        <tr>
            <td><table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="monographe">
                    ...
                    <tr>
                        ...
                        <td align="center"><div align="left">
                                <input name="projet" type="text" class="champ"   id="projet" value="<%=Utilitaire.remplacerNull(projet)%>"size="10"/>
                                &nbsp; <img src="images/blank.gif" width="16" height="16" align="absmiddle" /> </div></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="center"><div align="left">
                                <select name="table" class="champ" id="select2">
                                    <option value="factureClientorSansLc">Tous</option>
                                    <option value="factureCOrPaye" <%if(table.compareTo("factureCOrPaye")==0) out.println("selected");%>>paye</option>
                                    <option value="factureCOrNonPaye" <%if(table.compareTo("factureCOrNonPaye")==0) out.println("selected");%>>Impaye</option>
                                </select>
                            </div></td>
                ...
                for(int i=0;i<ag.length;i++){
                                %>
                                <option value="<%=ag[i].getId()%>" <%if(ag[i].getId().compareTo(Utilitaire.remplacerNull(request.getParameter("agence")))==0) out.println("selected");%>><%=ag[i].getVal()%></option>
                                <%
                }
                                %>
                            </select></td>
        ...
        <td> <p align="center"><strong><u>::RECAPITULATION::</u></strong></p>
            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" class="monographe">
                <tr class="head">
                    ...
                    <td width="20%" align="right"><div align="center">Or  </div></td>
        ...
        <td> <p align="center"><strong><u>RECAPITULATION RECHERCHE</u></strong></p>
            ...
            <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="monographe">
                <tr class="head">
                    ...
                    <td width="10%" align="right" valign="top"><div align="center">Clients</div></td>
                    ...
                    <td width="10%" align="center" valign="top">Mont Or </td>
          ...
          for(int i=0;i<factF.length; i++){
                ...
                <tr onmouseover="this.style.backgroundColor = '#EAEAEA'" onmouseout="this.style.backgroundColor = ''">
                    <td align="center"><a href="<%=lien%>?but=facture/visualiserFactureClient.jsp&idBC=<%=factF[i].getIdFactureFournisseur()%>&nature=FactureClient"><%=factF[i].getIdFactureFournisseur()%></a></td>
                    ...
                    <td align="right"><a href="<%=lien%>?but=ded/listeOR.jsp&idDed=<%=factF[i].getIdFactureFournisseur()%>"><%=utilitR.formaterAr(factF[i].getOpmontant())%> </a> </td>
