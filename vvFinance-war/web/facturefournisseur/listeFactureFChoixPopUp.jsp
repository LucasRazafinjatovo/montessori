...
<%!
  String apres="listeFactureFChoixPopUp.jsp";
  String nomFichier="listeFactureFChoixPopUp.jsp";
  String lien= null;
  UserEJB u = null;
  TypeObjet dev[] = null;
  Caisse caiss[] = null;
...
<%
  ...
  nomCol=Utilitaire.getNomColonne(new FactureFournisseur());
                ...
                //factF = u.findFactureF("%", "", "", "%", "%","%", "idFactureFournisseur", "ASC", "");
                         ...
                         ResultatEtSomme rs= u.findFactureFournisseurPage("facturefournisseurviseAop",idFact,  dateDebut,  dateFin, fournisseur, designation, colonne, ordre, apresW,pazy);
