...
<%!
  String apres="facturefournisseur/listeFactureAviser.jsp";
  String nomFichier="facturefournisseur/listeFactureAviser.jsp";
  String lien= null;
  UserEJB u = null;
  TypeObjet dev[] = null;
  Caisse caiss[] = null;
...
<%
  ...
  nomCol= Utilitaire.getNomColonne(new FactureFournisseur());
                ...
                //factF = u.findFactureF("%", "", "", "%", "%","%", "idFactureFournisseur", "ASC", "");
                         ...
                         ResultatEtSomme rs= u.findFactureFournisseurPage("facturefournisseurAvise",idFact,  dateDebut,  dateFin, fournisseur, designation, colonne, ordre, apresW,pazy);
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="600">
  ...
  %>
        <tr onmouseover="this.style.backgroundColor='#EAEAEA'" onmouseout="this.style.backgroundColor=''">
          <td align="center"><a href="<%=lien%>?but=facturefournisseur/viserFacture.jsp&numObjet=<%=factF[i].getTuppleID()%>&nature=<%=Constante.objetFactureFournisseur%>"><%=factF[i].getTuppleID()%></a></td>
