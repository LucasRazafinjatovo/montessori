...
<%!
        String apres="apreschoixLCDetail.jsp";
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="600">
 ...
 <br />
   ...
   <form action="<%=apres%>" method="POST" name="frmListe" id="frmListe">
   <input type="hidden" name="champReturn" value="<%=champReturn%>">
...
<td valign="top"><div align="center"><strong>Fact</strong></div></td>
  ...
  <td width="5%" valign="top"><!--DWLayoutEmptyCell-->&nbsp;</td>
          ...
          <input name="choix" type ="radio" onmousedown="getChoix()" value="<%=lcd[i].getId()%>" />
          </div></td>
