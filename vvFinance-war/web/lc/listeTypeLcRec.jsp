...
%>
<h1>Liste type LC Recette</h1>
<form action="<%=pr.getLien()%>?but=lc/listeTypeLcRec.jsp" method="post" name="listeactualite" id="listeactualite">
<%
out.println(pr.getFormu().getHtmlEnsemble());%>
</form>
<%
String lienTableau[]={pr.getLien()+"?but=lc/modifTypeLcRec.jsp"};
