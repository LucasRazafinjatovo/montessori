...
<table width="390" border="0" class="monographe">
  ...
  <tr>
    ...
    <td><div align="center"><a href=<%=lien%>?but=facture/visualiserFactureFournisseur.jsp&idBC=<%=det[0].getId1()%>&nature=FactureFournisseur><%=det[0].getId1()%></a></div></td>
  </tr>
  <tr>
    <td><div align="center"><span class="Style3">id 2 </span></div></td>
    <td><div align="center"><a href=<%=lien%>?but=lc/visualiserDetailLC.jsp&numObjet=<%=det[0].getId2()%>><%=det[0].getId2()%></a></div></td>
  </tr>
  <tr>
