...
<%!
        String apresFiltre="lc/listeLigneC.jsp";
		String apresChoix="lc/visualiserLC.jsp";
        String lien= null;
        UserEJB u = null;
        String designation="";
        String nomCol[]=null;
...
<form action="<%=lien%>?but=<%=apresChoix%>" method="post" name="listeLC" id="listeLC">
...
<% }
 ...
 %>
   ...
   <form action="<%=lien%>?but=<%=apresChoix%>" methode="POST" name="frmListe" id="frmListe">
