...
try{
   TypeObjet crt=new TypeObjet();
        ...
        tlc=(TypeObjet[])CGenUtil.rechercher(crt,null,null," and val not like 'pub' order by val asc");
...
<form action="listeLC2Choix.jsp?champReturn=<%=request.getParameter("champReturn")%>" method="post" name="listeLC" id="listeLC">
