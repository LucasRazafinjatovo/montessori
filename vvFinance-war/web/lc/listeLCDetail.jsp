...
<h1>Lister les lignes cr&eacute;dit &amp; Detail </h1>
...
<input type="text" class="champ" readonly="readonly" name="idType2" id="idType2" value="Dépense" />
<%} %>              </td>
 ...
 <tr>
            <td class="left">Compte det :</td>
            <td ><input name="numCompte2" type="text" class="champ" id="numCompte2" size="10" value="<%=numCompte2%>" /></td>
            <td class="left"> </td>
            <td>          </td>
          </tr>
 ...
 %>
   ...
   <form action="apreschoixLC.jsp" methode="POST" name="frmListe" id="frmListe">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="monographe">
        <!--DWLayoutTable-->
        <tr class="head">
          <td valign="top"><div align="center">choix</div></td>
  ...
  %>
        <tr>
          <td align="left" valign="top"><input name="indice" type="radio" id="numObjet" value=<%=i%> onClick=nombre.value=<%=i%>>
		 <input type="hidden" name="numObjet<%=i%>" value="<%=lcc[i].getIdLigne()%>">
		  </td>
          ...
          <td align="right" valign="top"><%=lcc[i].getComteDet()%></td>
