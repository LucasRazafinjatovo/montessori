...
<%!
        String apres="ded/listeOrdonnerPayement.jsp";
        String lien= null;
...
<h1>Choix Action Ordre payement </h1>
<h2>&nbsp;</h2>
...
<select name="action">
<option value="ded/visaOrdrePayement.jsp">VISA OP</option>
<option value="facturefournisseur/listeFactureFChoixDed.jsp">ATTACHER OP FACTURE</option>
<option value="ded/mvtCaisse.jsp">FAIRE UN MOUVEMENT DE CAISSE</option>
</select>
