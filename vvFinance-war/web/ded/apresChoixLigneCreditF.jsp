   ...
   <form action="<%=lien%>?but=lc/visualiserLCJointure.jsp" method="POST" name="frmListe" id="frmListe">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="monographe">
        ...
        <tr class="head">
          ...
          <td width="12%" height="19" valign="top"><div align="center"><strong>Crédit Actuel</strong></div></td>
  ...
  %>
        <tr>
          <td align="left" valign="top"><div align="center">
            <input name="idLC"  type='checkbox' class="radio" value="<%=lcc[i].getIdLigne()%>" checked>
          </div></td>
          ...
          <td align="right" valign="top"><div align="right">
             ...
             if(lcc[i].getMontantEng() != 0){
                %>
                      <a href="<%=lien+"?but=finance/listeSortie.jsp&idLigne="+lcc[i].getIdLigne() %>" title="Cliquer ici pour afficher les détails"><%=Utilitaire.formaterAr(lcc[i].getMontantEng())  %></a>
          ...
          <td align="right" valign="top"><div align="center">
            <input name="montant<%=i%>" type="text" class="champ" value="0">
</div></td>
