...
<table width="450" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <tr>
            ...
            <td align="center"><input name="daty" type="text" class="champ" id="daty" value="<%=Utilitaire.formatterDaty(op.getDaty()) %>" /></td>
            <td align="left">&nbsp;
          ...
          <tr>
            ...
            <td align="center"><textarea name="remarque" class="champ" id="remarque"><%=op.getRemarque()%></textarea></td></td>
            <td align="center">&nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle">            </td>
          </tr>
        </table></td>
    </tr>
