...
%>
	       ...
	       <script language="JavaScript"> document.location.replace("<%=lien%>?but=ded/detailGen.jsp&numObjet=<%=numObjet%>&nature=<%=Constante.getObjetBc()%>&tableDet=<%=Constante.getTableDetailBC()%>"); </script>
