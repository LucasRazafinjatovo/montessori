...
%>
  ...
  <h1>Modif attachement LC Recette</h1>
  ...
  <form action="<%=lien%>?but=ded/ORModifier.jsp" method="post" name="client" id="client" target="_parent">
  ...
  <table width="600" border="0" align="center" cellpadding="0"
          ...
          <tr>
                  ...
                  <table width="100%" border="0" align="center" cellpadding="2"
                          ...
                          <tr>
                            <td class="left" width="20%" valign="top"><div align="center">Num OR:<span class="remarque">*</span></div></td>
                            <td align="center" width="30%"><input type="text" name="num" class="champ" id="num" />
                            <input class="submit" type="button" value="..." onclick="pagePopUp('ded/choixOP.jsp?champReturn=num&etat=ordonnerrecette')" name="choix3"></td>
                          </tr>
                  </table>
                  </td>
          </tr>
