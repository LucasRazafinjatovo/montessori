...
<%!
        String apres="ded/apresvisaOrdrePayement.jsp";
        String lien= null;
...
<table width="100%" border="0" class="monographe">
   ...
   <tr>
            ...
            <td align="left">&nbsp;<input name="choix3" type="button" onClick="pagePopUp('ded/choix_OP.jsp?champReturn=idOP')" value="..." class="submit"><img src="images/blank.gif" width="16" height="16" align="absmiddle">            </td>
          </tr>
