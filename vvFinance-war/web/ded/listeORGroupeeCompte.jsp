...
String etat="ORPAYELCCOMPTE";
if(request.getParameter("etat")!=null && request.getParameter("etat").compareToIgnoreCase("")!=0)
  etat=request.getParameter("etat");
p.setNomTable(etat);
String listeCrt[] = {"id","remarque","ded_id","designationLc","idTypeLigne","identite","iddirection","annee","numCompte","idLigne","mois","daty","montant","compte"};
...
pr.setApres("ded/listeORGroupeeCompte.jsp");
...
<form action="<%=pr.getLien()%>?but=ded/listeORGroupeeCompte.jsp" method="post" name="listeOr" id="listeOr">
<%
