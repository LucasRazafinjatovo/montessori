...
try{
        ...
        op=((OrdonnerPayement[])u.findOpPage("ordonnerRecette", numObjet, "%", "%", "","","","","%",1).getResultat());
...
<form action="<%=lien%>?but=ded/updateVentilationOrFcLc.jsp" method="POST" name="frmListe" id="frmListe">
  <p align="center"><strong><u>LISTE SELECTION </u></strong></p>
  <p align="center"><u><strong><a href=<%=lien%>?but=ded/visualiserOR.jsp&idOP=<%=numObjet%>>Voir d&eacute;tails OR num <%=numObjet%></a></strong></u></p>
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="monographe">
    ...
    <tr class="head">
      ...
      <td width="25%" valign="top"><div align="center">id jointure FC LC</div></td>
  ...
  %>
    <tr>
      ...
      <td align="left" valign="top"><div align="center"><a href=<%=lien%>?but=lc/visualiserUnionIntraOr.jsp&nomTable=FactureClientLc&refDet=<%=lcc[i].getId2()%>><%=lcc[i].getId2()%></a></div></td>
...
%>
  ...
  <div align="center">
   ...
   <input name="typeor" type="hidden" id="typeor" value="<%=request.getParameter("typeor")%>">
...
<form action="<%=lien %>?but=ded/ventilationOrFcLc.jsp&numObjet=<%=numObjet%>&typeor=<%=request.getParameter("typeor")%>" method="post" name="listeLC" id="listeLC">
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="600">
 ...
 <br />
   ...
   <form action="<%=lien%>?but=lc/saveOrFcLcJointure.jsp" method="POST" name="frmChoix" id="frmChoix">
  ...
  %>
     ...
     <div align="center">
       ...
       <input type="hidden" name="typeor" value="<%=request.getParameter("typeor")%>">
       <input type="hidden" name="typeObjet" value="<%=typeObjet%>">
