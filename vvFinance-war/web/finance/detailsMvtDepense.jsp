...
try{
	...
	MvtCaisse[] list = (MvtCaisse[])CGenUtil.rechercher(p, null, null, " and daty = '" + request.getParameter("daty") + "' and credit = 0");
		
%>
<h1>D&eacute;tails mvt d&eacute;pense du <%=request.getParameter("daty")%></h1>
			...
			try{
				for(int i = 0; i < list.length; i++){
					...
					<tr onmouseover="this.style.backgroundColor='#EAEAEA'" onmouseout="this.style.backgroundColor=''">
						...
						<td align="right"><%=Utilitaire.formaterAr(list[i].getDebit())%></td>
