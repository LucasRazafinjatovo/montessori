...
<%!
        String apres="finance/situationEntreeCompte.jsp";
        String lien= null;
        UserEJB u = null;
        TypeObjet dev[] = null;
        Caisse caiss[] = null;
...
sc=u.findSyntheseCompteEntree(dateDebut, dateFin, caisse, entite, "%", "%");
