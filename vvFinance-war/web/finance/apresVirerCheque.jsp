...
<%!
     ...
     %>
<%
idFact=request.getParameter("idVrt");
String IdMvt = request.getParameter("IdMvt");
String datySaisieLettre = request.getParameter("datySaisieLettre");
String datyValeurLettre = request.getParameter("datyValeurLettre");
...
try
{
  ...
  caiss = u.findCaisse("%","%","%","%");
System.out.println("caiss.length HEHEHE==>"+caiss.length);
  ...
  <tr>
    <td> <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="monographe">
          <tr>
            ...
            <td align="center"> <input name="daty" type="text" class="champ" id="date" value="<%=datySaisieLettre%>" size="10" maxlength="10">
          ...
          <tr>
            ...
            <td align="center"> <input name="montant" type="text" class="champ" id="montant" size="20" maxlength="20"  value="<%=montant%>">
...
%>
          ...
          <tr>
            <td class="left" valign="top">Numéro de cheque :</td>
            <td align="center"> <input name="numCheque" type="text" class="champ" id="numCheque" value="<%=numCheque%>">
              &nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle">
            </td>
          </tr>
          <tr>
            <td class="left" valign="top">Remarque :</td>
            <td align="center"> <input name="remarque" type="text" class="champ" id="remarque" value="<%=remarque%>">
              &nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle">
            </td>
          </tr>
        </table></td>
