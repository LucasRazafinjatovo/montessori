...
pr.setApres("finance/listemvtnonr.jsp");
...
<form action="<%=pr.getLien()%>?but=finance/listemvtnonr.jsp" method="post" name="listePub" id="listePub">
<%
out.println(pr.getFormu().getHtmlEnsemble());%>

</form>
<%
String lienTableau[]={pr.getLien()+"?but=finance/rapprocherMVTcaisse.jsp"};
