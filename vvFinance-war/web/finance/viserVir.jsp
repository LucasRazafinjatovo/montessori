...
<h1>VISA VIREMENT ORDRE RECETTE </h1>
<h2>&nbsp;</h2>
...
<table width="100%" border="0" class="monographe">
   ...
   <tr>
            <td class="left">Ref Virement : <span class="remarque">*
              <input name="idVir" type="hidden" class="champ"  id="idOP" value="<%=numObjet%>" />
            </span></td>
            <td align="center"><%=numObjet%></td>
  ...
  <tr>
    ...
    <td align="center"><input name="rem" type="text" class="champ" id="rem" value="-" maxlength="20">
              &nbsp;</td><td></td>
  </tr>
  ...
  <tr>
          ...
          <input name="acte" type="hidden" id="acte" value="VISERVIR">
