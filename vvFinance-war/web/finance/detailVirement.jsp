...
SaisieVirement temp[]=u.findVirementNormale("saisievirementlettre",request.getParameter("id"),"%","%","%","%","","","");
...
<table width="450" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td> <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="monographe">
          ...
          <tr>
            <td class="left" valign="top">Num cheque :</td>
            <td align="center">  <%=sVir.getNumcheque()%>
            </td>
          </tr>
        </table></td>
        </tr>
  ...
  <tr>
          <td align="center"><input name="numObjet" type="hidden" id="numObjet" value="<%=request.getParameter("id") != null ? request.getParameter("id") : request.getParameter("idVir")%>">
