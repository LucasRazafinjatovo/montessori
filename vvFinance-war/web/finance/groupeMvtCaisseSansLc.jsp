...
<%
p=new MvtCaisse();
p.setNomTable("MVTCAISSELETTREValide");
...
pr.setApres("finance/groupeMvtCaisseSansLc.jsp");
...
<form action="<%=pr.getLien()%>?but=finance/groupeMvtCaisseSansLc.jsp" method="post" name="listePub" id="listePub">
<%
