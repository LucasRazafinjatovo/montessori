...
<%!
	...
	MvtStock2 mvt  = new MvtStock2();
	String id = request.getParameter("article");
        remarque = request.getParameter("remarque");
	MvtStock2[] listmvt = (MvtStock2[])CGenUtil.rechercher(mvt,null,null," and article like '%"+id+"%'order by id desc");
    String datyjour = Utilitaire.dateDuJour();
	...
	ag = u.findTypeObjet("Agence","%","%");
                prixarticle = ArticlePrix.getArticlePrix(id);
...
<table width="450" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <tr>
          ...
          <tr>
              ...
              <td align="center"><textarea name="remarque" class="champ" id="remarque" maxlength="100"><%=remarque%></textarea></td>
              <td align="center">&nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle"> </td>
          </tr>
          <tr>
            <td class="left">Montant : </td>
            <td align="center"><input name="montantTTC" type="text" class="champ" id="montantTTC" readonly="true" value="<%=prixarticle%>"/></td>
            <td align="center">&nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle"></td>
          </tr>
          <tr>
