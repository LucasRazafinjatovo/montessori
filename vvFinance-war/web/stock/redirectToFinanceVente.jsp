...
try
{
  ...
  prixunit = request.getParameter("prixunit");
  ...
  if(ut.getIdrole().compareTo("dg")==0)
  {
	...
	session.setAttribute("dir",ut.getAdruser());
        out.println("<script language='JavaScript'> document.location.replace('../"+lien+"?but=stock/avantVenteFacture.jsp&designation="+designation+"&prixunit="+prixunit+"&quantite="+quantite+"'); </script>");
  }
}catch (Exception e){
 %>
