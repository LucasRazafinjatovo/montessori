...
try
{
  ...
  //String idFact, String resp, String da, String mot, String mont,String type
   id= u.faireMvtStock(request.getParameter("designation"),"1",request.getParameter("valeur"),"0", "0",request.getParameter("valeur"),request.getParameter("tiers"), request.getParameter("magasin"),request.getParameter("unite"), request.getParameter("noteExplicative"));
