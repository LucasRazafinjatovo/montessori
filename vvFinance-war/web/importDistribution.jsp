<%-- 
    ...
    Created on : 7 févr. 2018, 09:26:46
    Author     : ando
--%>

<%@page import="mg.vv.service.ImportJournalPrise"%>
...
<%
    try {
        ...
        String lien = null;
        Object[] cm = null;
        ImportJournalPrise iji = new ImportJournalPrise();
                ...
                <div class="box box-primary box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title" color="#edb031">
                            <span color="#edb031" class="center">Import Excel PRISE</span></h3>                        
                    </div>
                    <div class="box-body" style="display: block;">
                        <form action="<%=lien%>?but=importDistribution.jsp&optionTypes=prise" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" value="prise" name="type" class="form-control" style="height: 30px; border: 1;">
