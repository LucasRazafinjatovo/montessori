...
<form action="listeArticleProductionChoix.jsp?champReturn=<%=request.getParameter("champReturn")%>" method="post" name="listearticleproductionchoix" id="listearticlecommandechoix">
<%
...
<br>
<form action="<%=pr.getLien() %>?but=apresChoixArticleCommande.jsp" method="post" name="frmchx" id="frmchx">
...
<td><input type="radio" name="choix" onMouseDown="getChoix()" value="<%=listeP[i].getLibelle()%>" class="radio" /></td>
