...
<form action="<%=lien%>?but=<%=apres%>" method="post" name="pub" id="pub" target="_parent">
  ...
  <table width="376" border="0" align="center" cellpadding="2" cellspacing="0" class="monographe">
    <tr>
      ...
      <td colspan="4"><input type="text" name="nom_client" class="champ">
    ...
    <tr>
      ...
      <td colspan="4"><input type="text" name="nom_campagne" class="champ" >
       </td>
    </tr>
    <tr>
...
{
  %>
<option value="<%=listePT[i].getId()%>"<% if(typee!=null && typee.compareTo(listePT[i].getId())==0) out.print("selected"); %>><%=listePT[i].getDesignation() %></option>
  <%
}
%>      </select>
     </td>
<td></td>
    ...
    <tr>
      ...
      <td colspan="4"><input type="text" name="date_debut" class="champ">
      </td>
    </tr>
        <tr>
      <td class="left">Date fin diffusion: </td>
      <td colspan="4"><input type="text" name="date_fin" class="champ"></td>
    </tr>
       <tr>
      <td class="left">Reference: </td>
      <td colspan="4"><input type="text" name="reference_pub" class="champ"></td>
    </tr>
    <tr>
      <td class="left">Confection pub: </td>
      <td colspan="4"><input type="text" name="confection_pub" class="champ"></td>
    </tr>
	<tr>
...
{
  %>
<option value="<%=listePH[i].getId()%>" <% if(plage_horaire!=null && plage_horaire.compareTo(listePH[i].getId())==0) out.print("selected"); %>><%=listePH[i].getDesignation()%></option>
  <%
}
%>
      </select>
  ...
  <tr>
      <input type="hidden" name="acte" value="insert">
           <input name="classe" type="hidden" id="classe" value="pub.PubTopRadio">
                <input type="hidden" name="bute" value="pub/pubradio-liste.jsp">
