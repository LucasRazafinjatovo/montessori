<%-- 
    Document   : ordonnerRecettePubRadio.jsp
    Created on : 12 juin 2017, 16:47:23
    Author     : Alain
--%>
...
<%
    ...
    try {
        ...
        String idmontant = (String) session.getValue("pubradio");
        session.removeAttribute("pubradio");
        session.setAttribute("pubradio", idmontant);
        montant = u.getSommeMontantPub(idmontant);
