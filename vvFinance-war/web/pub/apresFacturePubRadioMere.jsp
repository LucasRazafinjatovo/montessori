        ...
        try {
            ...
            if (acte.compareTo("INSERT") == 0) {
                if (request.getParameter("typefact").compareToIgnoreCase("normale") == 0){
                    idFactMere = u.createFactureMereRadio(date, dateDebut, dateFin, idClient, note, idTva, idFactureEn, idDeviseEn, reduction, idCategorie, idTypePaie, agence, entite, parution, modepaiement, dateLimite, g, request.getParameter("idTva"), request.getParameter("datyparu"));
