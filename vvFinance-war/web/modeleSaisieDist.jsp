                  ...
                  <td class="Style1"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        ...
                        <td bgcolor="#ffffff"><table cellspacing="0" cellpadding="0" border="0" align="center" width="120">
                            ...
                            <tr>
                              <td><img src="images/puce.gif" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=actualite/listeActu.jsp&premier=true" class="menu">Lister actualit&eacute; </a>&nbsp;</td>
                            </tr>
                        </table></td>
                        <td bgcolor="#FFFFFF"></td>
                      </tr>
...
<tr>
            ...
            <td width="71%" valign="top"><table width="100%" border="0">
                <tr>
                  <td><span class="modele">:: Saisie Distribution</span> </td>
                </tr>
                <tr>
                  <td><div align="center">
