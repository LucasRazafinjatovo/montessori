...
acte=request.getParameter("acte");if ((acte==null)||acte.compareTo("")==0) acte="save";
 ...
 u.mapperPrevisionRecetteLCTableau(numObjet, idLcArecup, "-", montant);
 ...
 %>
<script language="JavaScript"> document.location.replace("<%=lien%>?but=prevision/ventilationPrevLcRecette.jsp&numObjet=<%=numObjet%>&avecOp=<%=request.getParameter("avecOp")%>"); </script>
<%
}
catch(Exception e){
  e.printStackTrace();
