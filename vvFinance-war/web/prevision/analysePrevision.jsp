...
try{
  ...
  la = u.findAnalysePrevision(daty1,daty2,colonne,ordre,"AnalysePrevisioneffectif");
...
<h1>ANALYSE PREVISION</h1>
<!-- RECHERCHE -->
<form action="analysePrevision.jsp" method="post" name="analysePrevision" id="analysePrevision">
