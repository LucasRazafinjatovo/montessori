...
<table width="450" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr><td> <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="monographe">
	...
	<tr>
		<td class="left">ORR : <span class="remarque">*</span></td>
		<td align="center">          <input type="text" class="champ" name="listeor"/>
	  &nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle">            </td>
		<td align="center"><input name="choix" type="button" class="submit" onclick="pagePopUp('listeORChoix.jsp?champReturn=listeor')" value="..."></td>
	</tr>
  ...
  <tr>
          ...
          <input name="acte" type="hidden" id="acte" value="attacherorprev">
		<input name="typeor" type="hidden" id="typeor" value="prev">
		<input name="bute" type="hidden" id="bute" value="prevision/listePrevisionRecDetail.jsp">
