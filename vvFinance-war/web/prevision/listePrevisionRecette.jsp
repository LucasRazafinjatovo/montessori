...
pr.setApres("prevision/listePrevisionRecette.jsp");
...
<form action="<%=pr.getLien()%>?but=prevision/listePrevisionRecette.jsp" method="post" name="listePrevisionRecette" id="listePrevisionRecette">
<%
...
<br>
<form action="<%=pr.getLien()%>?but=prevision/attacherPrevOR.jsp" method="post">
<%
out.println(pr.getTableau().getHtmlWithRadio());
%>
   <input type="hidden" name="type" value="prevor" class="submit">
