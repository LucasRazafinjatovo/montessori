...
p.setNomTable("OrdonnerPayement");
...
pr.setApres("prevision/attacherOPPrev.jsp");
...
<form action="<%=pr.getLien()%>?but=prevision/attacherOPPrev.jsp" method="post" name="listeOrdonnerPayement" id="listeOrdonnerPayement">
<%
