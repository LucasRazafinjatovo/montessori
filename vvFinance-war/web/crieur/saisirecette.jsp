...
<%
RecettecLib rec=new RecettecLib();
rec.setNomTable("RecettecLib");
...
%>
 ...
 <input name="bute" type="hidden" id="bute" value="crieur/saisirecette.jsp">
 <input name="classe" type="hidden" id="classe" value="crieur.RecettecLib">
