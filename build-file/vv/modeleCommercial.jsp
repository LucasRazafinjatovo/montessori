                                    ...
                                    <tr>
                                        <td class="Style1"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td bgcolor="#ffffff"><table cellspacing="0" cellpadding="0" border="0" align="center" width="120">
                                                            <tr>
                                                                <td><img src="images/puce.gif" width="11" height="11">&nbsp; <a href="<%=lien%>?but=commercial/saisie-commercial.jsp" class="menu">Enreg commercial</a></td>
                                                            </tr>
                                                            <tr>
            ...
            <tr>
                <td class="Style1">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td  width="15" height="25"><img src="images/left.gif" width="15" height="25"></td>
                            <td background="images/bg.gif" width="94" align="center" class="haut">PUB RADIO</td>
                            <td width="23"><img src="images/right.gif" width="15" height="25"></td>
                        </tr>
                        <tr>
                            <td bgcolor="#FFFFFF"></td>
                            <td bgcolor="#ffffff">
                                <table cellspacing="0" cellpadding="0" border="0" align="center" width="120">
                                    <tr>
                                        <td><img src="images/puce.gif" width="11" height="11">&nbsp; <a href="<%=lien%>?but=pub/pubRadioPack-saisie.jsp" class="menu">Enreg pub</a></td>
                                    </tr>

                                    <tr>
                                        <td><img src="images/puce.gif" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=pub/pubRadioPack-liste.jsp" class="menu">Lister pub </a>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td><img src="images/puce.gif" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=pub/pubTarifPack-saisie.jsp" class="menu">Saisie tarif</a>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td><img src="images/puce.gif" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=pub/pubTarif-liste.jsp" class="menu">Historique tarif</a></td>
                                    </tr>

                                    <tr>
                                        <td><img src="images/puce.gif" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=pub/pubRadioOr-liste.jsp" class="menu">OR via liste pub</a>&nbsp;</td>
                                    </tr>


                                    <tr>
                                        <td><img src="images/puce.gif" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=pub/pubType-saisie.jsp" class="menu">Saisie type pub</a>&nbsp;</td>
                                    </tr>

                                    <tr>
                                        <td><img src="images/puce.gif" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=pub/pubType-liste.jsp" class="menu">Lister type pub</a>&nbsp;</td>
                                    </tr>

                                    <tr>
                                        <td><img src="images/puce.gif" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=pub/pubPlagehoraire-saisie.jsp" class="menu">Saisir Plage horaire</a>&nbsp;</td>
                                    </tr>

                                    <tr>
                                        <td><img src="images/puce.gif" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=pub/pubPlagehoraire-liste.jsp" class="menu">Lister Plage horaire</a>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td><img src="images/puce.gif" width="11" height="11">&nbsp;&nbsp;<a href="<%=lien%>?but=pub/etatPubRadio-liste.jsp" class="menu">etat pub radio</a>&nbsp;</td>
                                    </tr>
                                </table>
                            </td>
                            <td bgcolor="#FFFFFF"></td>
