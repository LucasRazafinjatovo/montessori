...
<%!
	...
	UserEJB u = null;
	String id = null;
	Invenducrieur p = null;
	Invenducrieur[] lp = null;
	InvenducLib pl = null;
	InvenducLib[] lpl = null;
	String type = null;
     %>
	<%
	...
	try{
		...
		p=new Invenducrieur();
		p.setId(id);
		lp=(Invenducrieur[])CGenUtil.rechercher(p,null,null,"");
		pl=new InvenducLib();
		pl.setId(id);
		lpl=(InvenducLib[])CGenUtil.rechercher(pl,null,null,"");
	}catch(Exception e){
	%>
					...
					<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="monographe">
						...
						<tr>
							...
							<td align="center"> <%=lpl[0].getJournal()+" "+lpl[0].getParution()%>
								<input name="publicat" type="hidden" id="idprise" value="<%=lp[0].getIdprise()%>">&nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td align="center"> <input type="text" name="nbre" id="champ" value="<%=lp[0].getNombreinvendu()%>"/>&nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle"></td>
						</tr>
					</table>
				</td>
			</tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td align="center">
							...
							<input type="hidden" name="classe" value="crieur.Invenducrieur">
