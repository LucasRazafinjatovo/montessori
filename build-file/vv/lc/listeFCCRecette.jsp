...
<%!
        String apres="lc/listeFCCRecette.jsp";
        String lien= null;
        UserEJB u = null;
        String designation="";
        String nomCol[]=null;
...
try{
        ...
        lcc = u.findFCC(idLC,designation,mois1,mois2,idType,numCompte,"%","%","%",entite,direction,colonne,ordre, annee,"lignecreditRecetteComplet");
...
<div align="center">
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="monographe">
    ...
    <tr class="head">
      ...
      <td width="18%" height="19" valign="top"><div align="center"><strong>Produits</strong></div></td>
      <td width="18%" valign="top"><div align="center"><strong>Or vise</strong></div></td>
      <td width="18%" valign="top"><div align="center">Facture vise </div></td>
      <td width="18%" align="center" valign="top"><strong>Facture - Or </strong></td>
    </tr>
    <tr>
      ...
      <td align="left" valign="top"><div align="right"><a href="<%=lien %>?but=facturefournisseur/critereEntreFactureOr.jsp<%=critere1F %>"><%=Utilitaire.formaterAr(globale[4])%> Ar</a></div></td>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="monographe">
  ...
  for(int i=0;i<groupeEntite.length;i++){
    critere2 = "&etat=orPayelc&idLC="+Utilitaire.remplacePourcentage(request.getParameter("idLC"))+"&direction="+Utilitaire.remplacePourcentage(request.getParameter("direction"))+"&entite="+groupeEntite[i].getColonneGroupe()[0]+"&numCompte="+Utilitaire.remplacePourcentage(request.getParameter("numCompte"))+"&mois1="+Utilitaire.remplacePourcentage(request.getParameter("mois1"))+"&mois2="+Utilitaire.remplacePourcentage(request.getParameter("mois2"))+"&annee="+Utilitaire.remplacePourcentage(request.getParameter("annee"))+"&idType="+Utilitaire.remplacePourcentage(request.getParameter("idType"));
    critere2F = "&table=factureclientorgroupe&idLC="+Utilitaire.remplacePourcentage(request.getParameter("idLC"))+"&direction="+Utilitaire.remplacePourcentage(request.getParameter("direction"))+"&entite="+groupeEntite[i].getColonneGroupe()[0]+"&numCompte="+Utilitaire.remplacePourcentage(request.getParameter("numCompte"))+"&mois1="+Utilitaire.remplacePourcentage(request.getParameter("mois1"))+"&mois2="+Utilitaire.remplacePourcentage(request.getParameter("mois2"))+"&annee="+Utilitaire.remplacePourcentage(request.getParameter("annee"))+"&idType="+Utilitaire.remplacePourcentage(request.getParameter("idType"));

%>
  <tr>
    <td align="left" valign="top"><div align="center"><a href="<%=lien %>?but=lc/listeLC2Recette.jsp&entite=<%=(groupeEntite[i].getColonneGroupe()[0])%>&annee=<%=annee%>&idType=<%=Utilitaire.remplacePourcentage(idType)%>"><%=(groupeEntite[i].getColonneGroupe()[0])%></a></div></td>
    ...
    <td align="left" valign="top"><div align="right"><a href="<%=lien %>?but=facturefournisseur/critereEntreFactureOr.jsp<%=critere2F %>"><%=Utilitaire.formaterAr(groupeEntite[i].getSommeGroupe()[2])%> Ar</a></div></td>
...
%>
        <tr>
          ...
          <td align="left" valign="top"><div align="right"><a href="<%=lien %>?but=facturefournisseur/critereEntreFactureOr.jsp<%=critere3F %>"><%=Utilitaire.formaterAr(groupeEntiteMois[i].getSommeGroupe()[2])%>Ar</a></div></td>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="monographe">
  ...
  for(int i=0;i<groupeDesignation.length;i++){
	...
	String criteredsc = "&etat=orPayelc&idLC="+Utilitaire.remplacePourcentage(request.getParameter("idLC"))+"&designation="+groupeDesignation[i].getColonneGroupe()[0]+"&entite="+Utilitaire.remplacePourcentage(request.getParameter("entite"))+"&numCompte="+Utilitaire.remplacePourcentage(request.getParameter("numCompte"))+"&mois1="+Utilitaire.remplacePourcentage(request.getParameter("mois1"))+"&mois2="+Utilitaire.remplacePourcentage(request.getParameter("mois2"))+"&annee="+Utilitaire.remplacePourcentage(request.getParameter("annee"))+"&idType="+Utilitaire.remplacePourcentage(request.getParameter("idType"));
    String criteredscf = "&table=factureclientorgroupe&idLC="+Utilitaire.remplacePourcentage(request.getParameter("idLC"))+"&designation="+groupeDesignation[i].getColonneGroupe()[0]+"&entite="+Utilitaire.remplacePourcentage(request.getParameter("entite"))+"&numCompte="+Utilitaire.remplacePourcentage(request.getParameter("numCompte"))+"&mois1="+Utilitaire.remplacePourcentage(request.getParameter("mois1"))+"&mois2="+Utilitaire.remplacePourcentage(request.getParameter("mois2"))+"&annee="+Utilitaire.remplacePourcentage(request.getParameter("annee"))+"&idType="+Utilitaire.remplacePourcentage(request.getParameter("idType"));
...
%>
  <tr>
    <td align="left" valign="top">
		<div align="center">
			<a href="<%=lien %>?but=lc/listeLC2Recette.jsp&designation=<%=(groupeDesignation[i].getColonneGroupe()[0])%>&annee=<%=annee%>&idType=<%=Utilitaire.remplacePourcentage(idType)%>"><%=(groupeDesignation[i].getColonneGroupe()[0])%></a>
		</div>
	</td>
    <td align="left" valign="top">
    ...
    <td align="left" valign="top">
		<div align="right">
			<strong>
				<a href="<%=lien %>?but=ded/listeOR.jsp<%=criteredsc %>"><%=Utilitaire.formaterAr(groupeDesignation[i].getSommeGroupe()[3])%>Ar</a>
			</strong>
		</div>
	</td>
    <td align="left" valign="top">
		<div align="right">
			<a href="<%=lien %>?but=facturefournisseur/critereEntreFactureOr.jsp<%=criteredscf%>"><%=Utilitaire.formaterAr(groupeDesignation[i].getSommeGroupe()[2])%> Ar</a>
		</div>
	</td>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="monographe">
  ...
  <tr>
    ...
    <td align="left" valign="top"><div align="right"><a href="<%=lien %>?but=facturefournisseur/critereEntreFactureOr.jsp<%=critere4F %>"><%=Utilitaire.formaterAr(groupeDirection[i].getSommeGroupe()[2])%> Ar</a></div></td>
...
%>
  ...
  <tr>
          ...
          <td align="left" valign="top"><div align="right"><a href="<%=lien %>?but=facturefournisseur/critereEntreFactureOr.jsp<%=critere5F %>"><%=Utilitaire.formaterAr(groupeDirectionMois[i].getSommeGroupe()[2])%>Ar</a></div></td>
