...
<form action="listeLC2RecetteChoix.jsp?champReturn=<%=request.getParameter("champReturn")%>" method="post" name="listeLC" id="listeLC">
...
<td width="10%" align="right" bgcolor="#C300FF"><strong>Type LC</strong></td>
 ...
 <br />
   ...
   <form action="apresLcChoix.jsp" methode="POST" name="frmchx" id="frmListe">
...
<td width="10%" valign="top"><div align="center"><strong>Type</strong></div></td>
  ...
  %>
        <tr>
       <td> <input type="radio" name="choix" onMouseDown="getChoix()" value="<%=lcc[i].getIdLigne()%>" class="radio" /></td>
