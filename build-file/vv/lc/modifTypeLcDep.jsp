...
<%
    UserEJB u;
    Typelcdepense p = new Typelcdepense();
    p.setNomTable("typelcdepensetous");
...
%>
<h1> Modification Type LC D&eacute;pense</h1>
...
<form action="<%=(String) session.getValue("lien")%>?but=pub/apresTarif.jsp" method="post" name="configuration" id="idvaldesce">
	...
	<input name="bute" type="hidden" id="bute" value="lc/listeTypeLcDep.jsp">
