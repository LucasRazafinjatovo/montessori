...
pr.setApres("lc/dupliquerListeLC.jsp");
/*
affichage.Champ[] liste=new affichage.Champ[3];

TypeObjet to=new TypeObjet();
to.setNomTable("typesortieliste");
liste[0]=new Liste("typeLC",to, "val", "val");

Direction dir = new Direction();
liste[1]=new Liste("abbrevdir",dir, "abbrevDir", "abbrevDir");
...
%>
<h1>Lister Ligne crédit</h1>
<form action="<%=pr.getLien()%>?but=lc/dupliquerListeLC.jsp" method="post" name="rapprochement" id="rapprochement">
<%
out.println(pr.getFormu().getHtmlEnsemble());%>
</form>
<%
String lienTableau[]={pr.getLien()+"?but=lc/visualiserDetailLC.jsp"};
...
<form action="<%=pr.getLien()%>?but=lc/dupliqueMultipleLC.jsp" method="post" name="listePub" id="listePub">
	...
	%>
	<input type="hidden" name="classeLC" value="LigneCreditComplet">
	<input type="hidden" name="apresDupl" value="dupliquerListeLC">
</form>
<%
