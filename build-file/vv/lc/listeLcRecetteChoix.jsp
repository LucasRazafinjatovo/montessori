...
<h1>liste des lignes cr&eacute;dit recette </h1>
<p align="center" class="remarque">(choisir les crit&egrave;res de votre recherche
  concernant les lignes cr&eacute;dit)</p>
<form action="<%=lien %>?but=lc/listeLcRecetteChoix.jsp&numObjet=<%=numObjet%>&montantObjet=<%=montantObjet%>" method="post" name="listeLC" id="listeLC">
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="600">
 ...
 <br />
   ...
   <form action="<%=lien%>?but=lc/saveLCJointureRecette.jsp" method="POST" name="frmListe" id="frmListe">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="monographe">
        ...
        <tr class="head">
          ...
          <td width="25%" valign="top"><div align="center">Entite</div></td>
  ...
  %>
        <tr>
          ...
          <td align="left" valign="top"><div align="left"><%=lcc[i].getEntite()%></div></td>
