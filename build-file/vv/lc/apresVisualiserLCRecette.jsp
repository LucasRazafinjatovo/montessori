...
%>
	       ...
	       <script language="JavaScript"> document.location.replace("<%=lien%>?but=lc/modifierLCRecette.jsp&numObjet=<%=numObjet%>"); </script>


<%}  
if(acte.compareToIgnoreCase("dupliquer")==0){ 
%>
	<script language="JavaScript"> document.location.replace("<%=lien%>?but=lc/dupliquerLC.jsp&numObjet=<%=numObjet%>&classeLC=LigneCreditRecette&apresDupl=listeLC2Recette"); </script>
<%}  
%>
