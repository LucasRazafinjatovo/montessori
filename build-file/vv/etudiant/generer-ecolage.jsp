...
<h1>Generer &eacute;colage</h1>
<form action="<%=pr.getLien()%>?but=etudiant/generer-ecolage.jsp" method="post" name="etudiantencours" id="etudiantencours">
    <%
...
<form method="POST" action="<%=pr.getLien()%>?but=etudiant/apresGenererEcolage.jsp">
    <input name="acte" type="hidden" id="nature" value="generer">
    <input name="bute" type="hidden" id="bute" value="etudiant/generer-ecolage.jsp">
