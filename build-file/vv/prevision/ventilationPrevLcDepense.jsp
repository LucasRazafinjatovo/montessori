...
try{
   ...
   op=(PrevisionDepense[])u.findPrevisionPage("PrevisionDepense", numObjet, "");
...
<form action="<%=lien%>?but=prevision/updateVentilationPrevDepLc.jsp" method="POST" name="frmListe" id="frmListe">
...
<p align="center" class="remarque">(choisir les crit&egrave;res de votre recherche
  concernant les lignes cr&eacute;dit)</p>
	...
	<!--DEBUT recherche-->
<form action="<%=lien %>?but=prevision/ventilationPrevLcDepense.jsp&numObjet=<%=numObjet%>&typeor=<%=request.getParameter("typeor")%>" method="post" name="listeLC" id="listeLC">
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="600">
 ...
 <br />
   ...
   <form action="<%=lien%>?but=prevision/savePrevDepLcJointure.jsp" method="POST" name="frmChoix" id="frmChoix">
  ...
  %>
       <tr>
         <td align="left" valign="top"><div align="center">
           <span class="tdc1">
           <input name="idLC" onchange="checkBoxer(this,<%=lccAchoix.length%>)" class="checkbox"  type="checkbox" value="<%=lccAchoix[i].getIdLigne()%>">
         </span> </div></td>
