...
try{
	...
	op=(PrevisionRecette[])u.findPrevisionPage("previsionrecette", numObjet, "");
	if(op.length==0)throw new Exception("Prevision recette non existante");
	...
	uit.setNomTable("PREVRECLCLETTRE");
