			...
			try{
				for(int i = 0; i < list.length; i++){
					...
					<tr onmouseover="this.style.backgroundColor='#EAEAEA'" onmouseout="this.style.backgroundColor=''">
						<td align="center">
							<td align="center">
								<a href="<%=lien%>?but=finance/modifierORPrevision.jsp&id=<%=list[i].getId()%>"><%=list[i].getId()%></a>
							</td>
						</td>
