...
p.setNomTable("ANALYSEPREV_sans_typecharge_g");
...
to.setNomTable("typecharge");
liste[2] = new Liste("typecharge",to,"val","val");
pr.getFormu().getChamp("annee").setDefaut(String.valueOf(Utilitaire.getAneeEnCours()));
pr.getFormu().changerEnChamp(liste);
pr.setNpp(400);
pr.creerObjetPage();
%>
<h1>Grouper analyse pr&eacute;vision SANS TYPECHARGE</h1>
<form action="groupeAnalysePrevision_2.jsp" method="post" name="groupePrev" id="groupePrev">
<%
