...
<%!
	...
	nature=request.getParameter("nature");
        ...
        lcstring = request.getParameter("lcstring");

		ArticleBL[] listelc = ArticleBL.getNumLC("idBL");
		for(int i = 0; i < listelc.length; i++){
			lcliste += listelc[i].getLcunique()+", ";
		}

		if ((nature==null)||nature.compareTo("")==0) nature="FactureFournisseur";
...
<tr>
 ...
 <td align="center"> <textarea name="designation" class="champ"  id="designation"><%=designation%></textarea>
   &nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle">         </td>
 <td align="center">&nbsp;</td>
 </tr>
          <tr>
          ...
          <tr>
            ...
            <td align="center">          <input type="text" class="champ" name="fournisseur" readonly="true" value="<%=fournisseur%>"/>
              &nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle">            </td>
          ...
          <tr>
            ...
            <td align="center"><input name="montantTTC" type="text" class="champ" id="montantTTC" readonly="true" value="<%=montant%>"/>
              &nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle">            </td>
            <td align="center">&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            <td class="left">Lc unique : </td>
            <td align="center"><input type="text" class="champ" name="lc" value="<%=lcstring%>" readonly="true" />
              &nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle">            </td>
  ...
  <tr>
          ...
          <input name="acte" type="hidden" id="acte" value="INSERT2">
		   <input name="idBL" type="hidden" id="idBL" value="<%=%>">
