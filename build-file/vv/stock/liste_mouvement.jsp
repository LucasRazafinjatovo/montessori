...
<%
        ...
        <%
          totalDebit=totalDebit+mvt[i].getDebit();
        totalCredit=totalCredit+mvt[i].getCredit();

                }
                reste =totalDebit-totalCredit;
        ...
        %>
		 <tr onmouseover="this.style.backgroundColor='#EAEAEA'" onmouseout="this.style.backgroundColor=''">
          ...
          <td align="right"><strong><%=totalDebit%></strong></td>
        <td align="right"><strong><%=totalCredit%></strong></td>
        <td align="right"></td>
        </tr>
		 <tr onmouseover="this.style.backgroundColor='#EAEAEA'" onmouseout="this.style.backgroundColor=''">

          <td align="center" colspan="3"><strong>RESTE</strong></td>

          <td align="right" colspan="2"><%=reste%></td>
