...
<table width="450" border="0" align="center" cellpadding="0" cellspacing="0" class="monographe">
 ...
 <tr>
  ...
  <tr>
	...
	<table width="100%" border="0">
  <tr>
    <td align="center"><input type="button" onclick="page('<%=lien%>?but=stock/magasin_dest_entrepot.jsp&id=<%=id%>')" class="submit" value="Détail Magasins"></td>
    <td align="center"><input type="button" onclick="page('<%=lien%>?but=stock/dossier_mouvement.jsp&id=<%=id%>&urlRetour=confirmation_mouvement_entrepot.jsp')" class="submit" value="Détail dossiers"></td>
    <td align="center"><input type="button" onclick="page('<%=lien%>?but=stock/saisir_bobine.jsp&id=<%=id%>&urlRetour=confirmation_mouvement_entrepot.jsp')" class="submit" value="Détail bobines"></td>
  </tr>
</table>
