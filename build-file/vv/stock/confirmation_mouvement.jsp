...
<h1>Confirmation de mouvement</h1>
<h2>&nbsp;</h2>
<table width="450" border="0" align="center" cellpadding="0" cellspacing="0" class="monographe">
 ...
 <tr>
  ...
  <tr>
     <td align="center"><input type="button" onclick="page('<%=lien%>?but=stock/dossier_mouvement.jsp&id=<%=id%>&urlRetour=confirmation_mouvement.jsp')" class="submit" value="Détail dossiers"></td>
    <td align="center"><input type="button" onclick="page('<%=lien%>?but=stock/saisir_bobine.jsp&id=<%=id%>&urlRetour=confirmation_mouvement.jsp')" class="submit" value="Détail bobines"></td>
   </tr>
</table>
