...
compte= request.getParameter("compte");
  if ((dateDebut == null)|| dateDebut.compareTo("")==0) dateDebut="";
    if ((dateFin == null)|| dateFin.compareTo("")==0) dateFin="";
      ...
      mvt=u.findMvtStock(id,dateDebut,dateFin,"1",compte);
...
<%
        ...
        <tr onmouseover="this.style.backgroundColor='#EAEAEA'" onmouseout="this.style.backgroundColor=''">
          ...
          <td align="center"><a href="<%=lien%>?but=stock/detailLivraison.jsp&id=<%=mvt[i].getId()%>"><%=mvt[i].getId()%></a></td>
