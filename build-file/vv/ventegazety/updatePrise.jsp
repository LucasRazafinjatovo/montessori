...
<%!
        ...
        String id=null;
        Prisejournal p=null;
        Prisejournal[] lp=null;
        Prisejournallib pl=null;
        Prisejournallib[] lpl=null;
        String type=null;
     %>
<%
...
p=new Prisejournal();
p.setId(id);
lp=(Prisejournal[])CGenUtil.rechercher(p,null,null,"");
pl=new Prisejournallib();
pl.setId(id);
lpl=(Prisejournallib[])CGenUtil.rechercher(pl,null,null,"");
}catch(Exception e){
%>
    ...
    <td> <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="monographe">
         ...
         <tr>
          ...
          <tr>
            ...
            <td align="center"><input name="publicat" type="text" id="caisse" value="<%=lpl[0].getJournal()+" "+lpl[0].getNumparution()%>">
             <!-- <input name="publicat" type="hidden" id="publicat" value="lp[0].getPublicat()">-->
              &nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle">        </td>
          </tr>
          ...
          <tr>
            ...
            <td align="center"><%=lpl[0].getVendeur()%>
              <input value="<%=lp[0].getVendeur()%>" type="hidden" name="vendeur" value="vendeur" class="submit"/>
              &nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle">            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td align="center"> <input type="text" name="nbre" id="champ" value="<%=lp[0].getNbreprise()%>"/>
              &nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle">            </td>
          </tr>
        </table></td>
    </tr>
