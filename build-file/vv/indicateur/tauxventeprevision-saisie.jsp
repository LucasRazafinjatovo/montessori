...
<%       
TauxVentePrevision pj=new TauxVentePrevision();
...
<h1>Saisie Taux de vente pr&eacute;visionnel</h1>
...
<input type="reset" name="Submit2" value="Annuler" class="submit">
 ...
 <input name="bute" type="hidden" id="bute" value="indicateur/tauxventeprevision-saisie.jsp">
