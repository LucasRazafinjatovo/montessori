...
<input name="nom" type="text" class="champ" id="nom" value="">
                  </td>
          </tr>
          <tr>
            <td height="23" valign="top" class="left">R&eacute;gime :</td>
                  <td align="center" valign="top">
<input name="regime" type="text" class="champ" id="regime" value="">
                  </td>
          </tr>
          <tr>
            <td height="23" valign="top" class="left">Mail :</td>
                  <td align="center" valign="top">
<input name="mail" type="text" class="champ" id="mail" value="">
                  </td>
          </tr>
          <tr>
            <td height="23" valign="top" class="left">G&eacute;rant :</td>
                  <td align="center" valign="top">
<input name="ger" type="text" class="champ" id="ger" value="">
                  </td>
          </tr>
          <tr>
            <td height="23" valign="top" class="left">Logo :</td>
                  <td align="center" valign="top">
<input name="logo" type="text" class="champ" id="logo" value="">
                  </td>
          </tr>
          <tr>
            <td height="23" valign="top" class="left">Capital :</td>
                  <td align="center" valign="top">
<input name="capital" type="text" class="champ" id="capital" value="">
                  </td>
          </tr>
          <tr>
                  <td height="23" valign="top" class="left">Num. compte 1 :</td>
                  <td align="center" valign="top">
<input name="banque1" type="text" class="champ" id="banque1" value="">
                  </td>
          </tr>
          <tr>
                  <td height="23" valign="top" class="left">Num. compte 2 :</td>
                  <td align="center" valign="top">
<input name="banque2" type="text" class="champ" id="banque2" value="">
                  </td>
          </tr>
          <tr>
            <td height="23" valign="top" class="left">T&eacute;l&eacute;phone
              :</td>
                  <td align="center" valign="top">
<input name="phone" type="text" class="champ" id="phone" value="">
                  </td>
          </tr>
          <tr>
            <td height="23" valign="top" class="left">Fax :</td>
                  <td align="center" valign="top">
<input name="fax" type="text" class="champ" value="">
                  </td>
          </tr>
...
<textarea name="adr" rows="5" class="champ" id="adr"></textarea>
                  </td>
          </tr>
          <tr>
            <td height="23" valign="top" class="left">Num&eacute;ro statistique
              :</td>
                  <td align="center" valign="top">
<input name="stat" type="text" class="champ" id="numStat2" value="">
                  </td>
          </tr>
          <tr>
            <td height="23" valign="top" class="left">NIF :</td>
                  <td align="center" valign="top">
<input name="nif" type="text" class="champ" id="nif" value="">
                  </td>
          </tr>
          <tr>
            <td height="23" valign="top" class="left">RC n&deg; :</td>
                  <td align="center" valign="top">
<input name="rc" type="text" class="champ" id="rc" value="">
                  </td>
          </tr>
          <tr>
                  <td height="23" valign="top" class="left">Taxe prof. :</td>
                  <td align="center" valign="top" >
<input name="tp" type="text" class="champ" id="tp2" size="18" value="">
                  </td>
          </tr>
          <tr>
                  <td height="66" valign="top" class="left">Quittance n&deg; :</td>
                  <td align="center" valign="top" >
<input name="quittance" type="text" class="champ" id="quittance" value="" size="18">
                    <br>
                    <input name="acte" type="hidden" id="acte3" value="INSERT"> <input name="idSoc" type="hidden" id="idSoc" value=""></td>
          </tr>
          <tr>
...
%>
                <option value="<%=enti[i].getId()%>"><%=enti[i].getVal()%></option>
                <%
}
%>
              </select></td>
