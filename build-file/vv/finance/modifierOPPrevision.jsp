...
<table width="450" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td height="30" align="center">
			...
			<tr>
                <td>
					<input name="acte" type="hidden" id="nature" value="updateopp"/>
					<input name="bute" type="hidden" id="bute" value="finance/modifierOPPrevision.jsp&id=<%=mvt[0].getId()%>"/>
