...
&nbsp;            </td>
            <td align="center"><input name="choix3" type="button" onClick="pagePopUp('facturefournisseur/choix_f.jsp?champReturn=idFacture')" value="..." class="submit">  </td>
          </tr>
          <tr>
...
%>
          ...
          <tr>
            ...
            <td align="center"><input name="numPiece" type="text" class="champ" id="numPiece" value="" />
              &nbsp;
            </td>
            <td align="center"><img src="images/blank.gif" width="16" height="16" align="absmiddle"></td>
          </tr>
          <tr>
            <td class="left">Type mouvement : <span class="remarque">*</span></td>
            <td align="center">
              <select name="typeMvt" class="champ" id="typeMvt">
                <%
for(int i=0;i<tmvt.length;i++){
%>
                <option value="<%=tmvt[i].getId()%>"><%=tmvt[i].getVal()%></option>
                <%
}
%>
                            </select>
