...
pr.setApres("finance/groupeMvtCaisse.jsp");
...
<form action="<%=pr.getLien()%>?but=finance/groupeMvtCaisse.jsp" method="post" name="listePub" id="listePub">
<%
