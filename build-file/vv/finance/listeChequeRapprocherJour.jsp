...
pr.setApres("finance/listeChequeRapprocherJour.jsp");
...
%>
<h1>Liste mouvement de caisse rapproch&eacute; par jour</h1>
<form action="<%=pr.getLien()%>?but=finance/listeChequeRapprocherJour.jsp" method="post" name="listePub" id="listePub">
<%
