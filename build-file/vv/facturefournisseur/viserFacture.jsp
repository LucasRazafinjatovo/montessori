...
<form action="<%=lien%>?but=facturefournisseur/apresEntreeFacture.jsp" method="post" >
  ...
  <tr>
    <td> <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="monographe">
         ...
         <tr>
            ...
            <td align="left">&nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle"> <a href="<%=lien%>?but=facture/visualiserFactureFournisseur.jsp&idBC=<%=numObjet%>&nature=FACTUREFOURNISSEUR">details</a> </td>
          </tr>
 <tr>
