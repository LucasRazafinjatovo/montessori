...
<%!
  String apres="facturefournisseur/listeFactureProfChoix.jsp";
  String nomFichier="facturefournisseur/listeFactureProfChoix.jsp";
  String apresChoix="ded/listeChoixDed.jsp";
  String lien= null;
  UserEJB u = null;
  TypeObjet dev[] = null;
  Caisse caiss[] = null;
...
<%
  ...
  nomCol=Utilitaire.getNomColonne(new FactureFournisseur());
                ...
                //factF = u.findFactureF("%", "", "", "%", "%","%", "idFactureFournisseur", "ASC", "");
                         ...
                         ResultatEtSomme rs= u.findFactureFournisseurPage("factureproffournisseurlettre",idFact,  dateDebut,  dateFin, fournisseur, designation, colonne, ordre, apresW,pazy);
...
<h1>Lister les factures Prof fournisseurs</h1>
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="600">
  <tr>
    <td> <p align="center"><strong><u>RECAPITULATION RECHERCHE</u></strong></p>
      ...
      <br>
      <p align="center"><strong><u>LISTE</u></strong></p><form action="<%=lien%>?but=<%=apresChoix%>" method="post">

     <input name="typeObjet" type="hidden" value="<%=Constante.getObjFactureProf()%>"> <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="monographe">
        <tr class="head">
