...
<form action="choix_f.jsp" method="post" name="listeRecette" id="listeRecette">
...
<br>
<br>
 <form  action="apreschoixF.jsp" method="post" name="frmchx" id="choix">
<input type="hidden" name="champReturn" value="<%=champReturn%>">
...
if (minpage>1){
%>
<a href="choix_f.jsp?id=<%=id%>&dateDebut=<%=dateDebut%>&dateFin=<%=dateFin%>&fournisseur=<%=fournisseur%>&designation=<%=designation%>&champReturn=<%=champReturn%>&pazy=<%=maxpage-15%>&maxpageS=<%=maxpage-15%>"> << </a>
...
if (pazy>minpage){
%>
<a href="choix_f.jsp?id=<%=id%>&dateDebut=<%=dateDebut%>&dateFin=<%=dateFin%>&fournisseur=<%=fournisseur%>&designation=<%=designation%>&champReturn=<%=champReturn%>&pazy=<%=pazy-1%>&maxpageS=<%=maxpage%>">&nbsp;&nbsp;<</a>
<%
}
%>
  ...
  %>
      <a href="choix_f.jsp?id=<%=id%>&dateDebut=<%=dateDebut%>&dateFin=<%=dateFin%>&fournisseur=<%=fournisseur%>&designation=<%=designation%>&champReturn=<%=champReturn%>&pazy=<%=i%>&maxpageS=<%=maxpage%>">[<%=i%>]</a>
      <%
}
  %>
...
if (maxpage<nbPage){
%>
<a href="choix_f.jsp?id=<%=id%>&dateDebut=<%=dateDebut%>&dateFin=<%=dateFin%>&fournisseur=<%=fournisseur%>&designation=<%=designation%>&champReturn=<%=champReturn%>&pazy=<%=maxpage+1%>&maxpageS=<%=maxpage+15%>"> >> </a>
<%
}
%>
</font>
