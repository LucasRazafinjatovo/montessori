...
<%!
  String apres="facturefournisseur/apresChoixFactureF.jsp";
  String lien= null;
  UserEJB u = null;
  TypeObjet dev[] = null;
  Caisse caiss[] = null;
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="600">
  <tr>
    <td> <p align="center"><strong><u>RECAPITULATION RECHERCHE</u></strong></p>
      ...
      <br>
      <p align="center"><strong><u>LISTE</u></strong></p><form action="<%=lien%>?but=facturefournisseur/apresChoixFactureF.jsp" method="post">
...
<td align="center"><input name="idFact" class="radio"  type='checkbox' value="<%=factF[i].getTuppleID()%>"></td>
