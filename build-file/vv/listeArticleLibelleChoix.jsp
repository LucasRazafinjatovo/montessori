...
<form action="listeArticleLibelleChoix.jsp?champReturn=<%=request.getParameter("champReturn")%>" method="post" name="listearticlelibellechoix" id="listearticlelibellechoix">
<%
