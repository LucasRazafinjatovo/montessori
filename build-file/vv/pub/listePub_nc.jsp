...
String etat="pubcompletnoncloture";
...
pr.setApres("pub/listePub_nc.jsp");
...
%>
<h1>Liste des pubicites non clotur&eacute;s Mois-1</h1>
<form action="<%=pr.getLien()%>?but=pub/listePub_nc.jsp" method="post" name="listePub" id="listePub">
<%
