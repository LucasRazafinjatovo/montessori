...
String etat="pubcompletcloturenonfacture";
p.setNomTable(etat);
...
pr.setApres("pub/listePub_cnf.jsp");
...
<form action="<%=pr.getLien()%>?but=pub/listePub_cnf.jsp" method="post" name="listePub" id="listePub">
<%
