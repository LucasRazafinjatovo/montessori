...
<% OpAAnnuler lv = new OpAAnnuler();
    ...
    pr.setApres("ded/or_a_decaler.jsp");
...
<section class="content-header">
    <h1>Liste OR a decaler</h1>
</section>
<section class="content">
    <form action="<%=pr.getLien()%>?but=ded/or_a_decaler.jsp" method="post" name="incident" id="incident">
        <%
    ...
    <form action="<%=pr.getLien()%>?but=ded/apresOrdonnerRecette.jsp" method="post" name="incident" id="incident">
        ...
        <input type="hidden" name="bute" value="ded/or_a_decaler.jsp">
