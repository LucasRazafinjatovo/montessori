...
<%
Oppaye p=new Oppaye();
String etat="OPPAYEMENT_SALAIRE";
...
<form action="<%=pr.getLien()%>?but=ded/etatOP.jsp" method="post" name="etatOp" id="etatOp">
<%
out.println(pr.getFormu().getHtmlEnsemble());%>
etat : <select name="etat" class="champ" id="etat" >
              <option value="OPPAYEMENT_SALAIRE">Tous</option>
            <option value="OPPAYEMENT_RATTACHER"  <%if(etat.compareTo("OPPAYEMENT_RATTACHER")==0) out.println("selected");%>> OP rattach&eacute; paiement</option>
            <option value="OPPAYEMENT_NONRATTACHER"  <%if(etat.compareTo("OPPAYEMENT_NONRATTACHER")==0) out.println("selected");%>> OP non-rattach&eacute; paiement</option>
</select>
</form>
<%
