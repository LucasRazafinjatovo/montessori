...
%>
<%
 nature=request.getParameter("nature");if ((nature==null)||nature.compareTo("")==0) nature="ded";
...
try{
        ...
        dir = u.findDirection("","","","","");
        ResultatEtSomme rs=u.findDedLcPage(idDED, designationDed, dateDebut, dateFin, "", "", "%", fournisseur, idLC
                , idType,numCompte, entite, direction, mois1, mois2, pazy);
        lcc=(DedLc[])rs.getResultat();
...
%>
          ...
          %>
              ...
              <td align="center">
                <div align="left">
                  <input name="idDED" type="text" class="champ"   id="idDED" value="<%=idDED%>"size="10"  />
                  </div></td>
            </tr>
            <tr>
...
&nbsp; <a href="javascript:cal1.popup()"><img src="calendar/img/cal.gif" alt="Cliquez ici pour choisir une date" width=16 height=16 border=0 align="absmiddle" /></a> </div></td>
            ...
            <tr>
              ...
              <td align="center"><div align="left">
  <input name="fournisseur" type="text" class="champ"   id="fournisseur" value="<%=fournisseur%>"size="10"/>
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="600">
    ...
    <td> <p align="center"><strong><u>::RECAPITULATION::</u></strong></p>
      ...
      <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" class="monographe">
        <tr class="head">
          ...
          <td width="20%" align="right">Montant HT </td>
          <td width="20%" align="right">Montant Taxe </td>
          <td width="20%" align="right">Montant TTC </td>
        </tr>
        <tr class="head" >
 ...
 <br />
   ...
   <form action="<%=lien%>?but=<%=apresChoix%>" method="POST" name="frmListe" id="frmListe">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="monographe">
        ...
        <tr class="head">
          ...
          <td width="12%" height="19" valign="top"><div align="center"><strong>Ded num </strong></div></td>
          <td width="12%" valign="top"><div align="center"><strong>Mont Ht </strong></div></td>
          <td width="10%" valign="top"><div align="center"><strong>Mt Taxe </strong></div></td>
  ...
  <input name="idDED" class="radio"  type='radio' value="<%=lcc[i].getId()%>">

		  </td>
          <td align="left" valign="top"><div align="center"><%=lcc[i].getDesignation()%></div></td>
          <td align="right" valign="top"><div align="center"><%=lcc[i].getId()%></div></td>
          <td align="right" valign="top"><div align="right"><%=lcc[i].getMontantHt()%>    </td>
          <td align="right" valign="top"><div align="center"><%=lcc[i].getTaxe()%></div></td>
          <td align="right" valign="top"><div align="center"><%=lcc[i].getIdDirection()%></div></td>
...
<input type="hidden" name="numObjet<%=i%>" value="<%=lcc[i].getId()%>">
<input type="hidden" name="montantObjet<%=i%>" value="<%=lcc[i].getMontantHt()%>  ">
        </tr>
        <%
  }
  %>
