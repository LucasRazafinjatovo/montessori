...
<%!
        ...
        String nomFichier="ded/apresChoixLCDetail.jsp";
        String lien= null;
        UserEJB u = null;
        String designation="";
        String nomCol[]=null;
...
%>
<%
nature2=request.getParameter("nature2");if ((nature2==null)||nature2.compareTo("")==0) nature2="LcDetail";
...
<h1>Lister les Demandes de d&eacute;penses </h1>
   ...
   <form action="<%=lien%>?but=ded/enregistrerDedJointure.jsp" method="POST" name="frmListe" id="frmListe">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="monographe">
        ...
        <tr class="head">
          ...
          <td  height="19" valign="top"><div align="center"><strong>idLC </strong></div></td>
...
<td valign="top"><div align="center"><strong>Fact</strong></div></td>
 <td valign="top"><div align="center"><strong>Montant</strong></div></td>
  ...
  %>
        <tr>
  <td  valign="top"><!--DWLayoutEmptyCell-->&nbsp;</td>
          <td  valign="top"><div align="center"><input name="idLC"  type='checkbox' class="radio" value="<%=lcd[i].getId()%>" checked>
          </div></td>
          <td  height="19" valign="top"><div align="center"><strong><%=lcd[i].getIdLc()%> </strong></div></td>
            <td valign="top"><div align="center"><strong><%=Utilitaire.formaterAr(lcd[i].getCompteDetail())%></strong></div></td>
          <td valign="top"><div align="center"><strong><%=Utilitaire.formaterAr(lcd[i].getMontantEng())%></strong></div></td>
          <td valign="top"><div align="center"><strong><%=Utilitaire.formaterAr(lcd[i].getMontantVis())%></strong></div></td>
  <td valign="top"><div align="center"><strong><%=Utilitaire.formaterAr(lcd[i].getMontantFact())%></strong></div></td>
   <td valign="top"><input name="montant<%=i%>" type="text" class="champ" value="<%=valeurPropose%>"><td>
        </tr>
        <%
  }
  %>
     ...
     <div align="center">
        <input type="hidden" name="numObjet" value="<%=numObjet%>">
                <input type="hidden" name="typeObjet" value="<%=typeObjet%>">
                <input type="hidden" name="montantObjet" value="<%=montantObjet%>">
   <input type="hidden" name="nature2" value="<%=nature2%>" style=" height : 17px;">
  ...
  <%
  if((typeObjet.compareToIgnoreCase(Constante.getObjetMvtCaisse())==0)&&(nature2.compareToIgnoreCase(Constante.getObjetLcDetail())==0))
  {
%>
  <input name="submit" type="submit" value="enregistrer groupe" onClick="acte.value='ventileGroupe'">
  <input name="submit" type="submit" value="enregistrer Valide groupe" onClick="acte.value='ventileValideGroupe'">
<%}%>
</div>
   </form>
   <br />
   <!-- Pagination -->
   <table border="0" cellpadding="0" cellspacing="0" align="center" width="600">
        <tr><td height="25"><b>Nombre de r&eacute;sultat :</b> <%=lcd.length%></td><td align="right"><strong>page</strong> <%=pazy%> <b>sur</b> <%=Math.floor(lcd.length/nbParPazy)+1%></td>
        </tr>
            <tr>
