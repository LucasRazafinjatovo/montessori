...
cri.setNomTable("OrdonnerPayement");
cri.setId(id);
...
<form action="<%=lien%>?but=ded/plan_duplication.jsp" method="post" name="payement" id="planRemboursement">
	<table border="0px" class="monographe">
		...
		<tr>
			...
			<td height="25px" align="center"><input type="text" placeholder="jj/mm/yyyy" tabindex="0" id="datyinf" name="datyinf"></td>
		</tr>
		<tr>
			<td class="left" height="25px" >Au:</td>
			<td height="25px" align="center"><input type="text" placeholder="jj/mm/yyyy" tabindex="1" id="datysup" name="datysup"></td>
		</tr>
		<tr>
