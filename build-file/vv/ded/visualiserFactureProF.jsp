...
<%!
  String apres="ded/apresvisualiserFactureProF.jsp";
  String lien= null;
...
<h1>Visualiser Facture proformat num <%=bc[0].getIdFactureFournisseur() %></h1>
<h2>&nbsp;</h2>
...
<tr>
            <td width="35%" class="left">Num Facture proformat: </td>
...
<input name="montantObjet" type="hidden" id="montantObjet" value="<%=bc[0].getMontantTTC() %>">
   <input type="hidden" name="acte" value="viser" />
              <input type="submit" name="Submit" value="Joindre avec OP" class="submit"
 onClick="acte.value='jDed'">&nbsp;
    <input type="submit" name="Submit" value="Visualiser Jointure OP" class="submit"
