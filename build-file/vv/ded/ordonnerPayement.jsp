...
$.ajax({
    url:'traitementClientAjax.jsp?recherche='+obj.value+'&action=tarifFact',
  ...
  <tr>
    <td> <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="monographe">
         ...
         <tr>
            ...
            <td align="left">&nbsp;<input name="choix3" type="button" onClick="pagePopUp('facturefournisseur/listeFactureFChoixPopUp.jsp?champReturn=idDed')" value="..." class="submit"><img src="images/blank.gif" width="16" height="16" align="absmiddle">            </td>
          </tr>
 <tr>
          ...
          <tr>
            ...
            <td align="center"><textarea name="remarque" style="width: 200px; height: 50px;" class="champ" id="remarque" maxlength="100" ></textarea></td>
            <td align="center">&nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle">            </td>
          </tr>
