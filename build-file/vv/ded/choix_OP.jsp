...
<%!
        String apres="ded/listeOP.jsp";
        String nomFichier="choix_OP.jsp";
        String lien= null;
        UserEJB u = null;
        String designation="";
        String nomCol[]=null;
...
//findOpPage(String id, String idDed, String idLigne, String daty1, String daty2, String montant1, String mont2, String rem, int numPage)
       ResultatEtSomme rsOP=u.findOpPage("opAviser",idOP, idDed, idLC, dateDebut, dateFin,"","","%", pazy);
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="600">
 ...
 <br />
   ...
   <form action="apresChoixOP.jsp" method="POST" name="frmListe" id="frmListe">
 ...
 <input name="nature" type="hidden" value="<%=nature%>">
    ...
    <td width="66" align="center" valign="top"></td>
          <td width="66" align="center" valign="top">id Op </td>
          <td width="66" align="center" valign="top">Date</td>
                   <td width="153" align="right" valign="top"><div align="center">id Facture F </div></td>
