...
<%!
        String apres="listeChoixDed.jsp";
		String apresChoix ="apresChoixDed.jsp";
        String nomFichier="choix_ded.jsp";
        String lien= null;
        UserEJB u = null;
        String designation="";
        String nomCol[]=null;
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="600">
 ...
 <br />
   ...
   <form action="<%=apresChoix%>" method="POST" name="frmListe" id="frmListe">
  ...
  <input name="idDED" class="radio"  type='radio' value="<%=lcc[i].getId()%>" onMouseDown="getChoix()">
<input type="hidden" name="champReturn" value="<%=champReturn%>">
		  </td>
