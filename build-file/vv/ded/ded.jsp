...
<h1>ENREGISTREMENT Demande Depense </h1>
<h2>&nbsp;</h2>
...
&nbsp;            </td>
          ...
          <tr>
            ...
            <td align="center"> <input type="text" class="champ" name="fournisseur" value=""/>&nbsp;            </td>
            <td align="center"><div align="left">
...
%>
                <option value="<%=dev[i].getValTva()%>"><%=dev[i].getValTva()%></option>
                <%
}
%>
                            </select>
