...
String etat="ANALYSE_COMPTA_OPPAYELC";
...
pr.setApres("ded/listeOPgroupe_anal.jsp");
...
<form action="<%=pr.getLien()%>?but=ded/listeOPgroupe_anal.jsp" method="post" name="listeopg" id="listeopg">
<%
out.println(pr.getFormu().getHtmlEnsemble());%>
etat : <select name="etat" class="champ" id="etat" >
              <option value="ANALYSE_COMPTA_OPPAYELC">Tous</option>
              <option value="ANALYSE_COMPTA_OPPAYELCAVISER"  <%if(etat.compareTo("opPayelcAViser")==0) out.println("selected");%>>non vise</option>
            <option value="ANALYSE_COMPTA_OPPAYELC"  <%if(etat.compareTo("opPayelc")==0) out.println("selected");%>> vise</option>
</select>
</form>
<%
