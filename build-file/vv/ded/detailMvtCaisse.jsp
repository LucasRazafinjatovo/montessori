...
<h1>Detail du Mouvement caisse <%=idMere%> </h1>
<h2>&nbsp;</h2>
...
<table width="450" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td> <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="monographe">
         ...
         <tr>
            <td class="left">id: <span class="remarque">*</span></td>
            <td align="center"> <input name="id" type="text" class="champ"  id="id">
              &nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle">
            </td>
          </tr>
		   <tr>
            <td class="left">Débit : </td>
            <td align="center"><input name="debit" type="text" class="champ" id="debit" />
              &nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle">
            </td>
          </tr>
          <tr>
            <td class="left">Crédit : </td>
            <td align="center"><input name="credit" type="text" class="champ" id="credit" />
              &nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle">
            </td>
          </tr>
          <tr>
            <td class="left">Tiers :</td>
            <td align="center"> <input name="tiers" type="text" class="champ" id="tiers">
              &nbsp;<img src="images/blank.gif" width="16" height="16" align="absmiddle">
            </td>
          </tr>
          <tr>
