...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="600">
 ...
 <br />
   ...
   <form action="<%=lien%>?but=ded/apresListeChoixDed.jsp" method="POST" name="frmListe" id="frmListe">
  ...
  %>
        <tr>
          <td align="left" valign="top"><input name="idLC" class="radio"  type='checkbox' value="<%=lcc[i].getId()%>"></td>
