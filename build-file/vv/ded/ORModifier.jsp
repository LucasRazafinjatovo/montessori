...
<td  align="right"><div align="center"><%=listeLc[y].getDesignationLc() %> </div></td>
         <td align="right"><div align="center"><%=listeLc[y].getIdEntite() %></div></td>
          ...
          <td align="right"><div align="center"><a href="<%=lien%>?but=ded/LCModifierRecette.jsp&idligne=<%=listeLc[y].getIdLigne()%>&numFact=<%=op.getDed_Id()%>&num=<%=idFact%>">Modifier</a></div></td>
