...
pr.setApres("ded/visaORMultiple.jsp");
...
<form action="<%=pr.getLien()%>?but=ded/visaORMultiple.jsp" method="post" name="visaORMultiple" id="visaORMultiple">
<%
...
<%
  String lienTableau[]={pr.getLien()+"?but=ded/visualiserOR.jsp",pr.getLien()+"?but=facture/visualiserFactureFournisseur.jsp",pr.getLien()+"?but=lc/visualiserDetailLC.jsp"};
String colonneLien[]={"id","ded_Id","idLigne"};
pr.getTableau().setLien(lienTableau);
pr.getTableau().setColonneLien(colonneLien);
out.println(pr.getTableauRecap().getHtml());%>
<form method="post" name="e" action="<%=pr.getLien()%>?but=ded/visaOrdreRecetteMultiple.jsp">
