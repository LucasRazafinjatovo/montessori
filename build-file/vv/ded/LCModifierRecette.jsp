...
<form action="<%=lien %>?but=ded/LCModifierRecette.jsp&idligne=<%=request.getParameter("idligne")%>&numFact=<%=request.getParameter("numFact")%>&num=<%=request.getParameter("num")%>" method="post" name="listeLC" id="listeLC">
      ...
      <td> <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="monographe">
          ...
          <tr>
            ...
            <td align="left"> <select name="annee" class="champ" id="annee">
                ...
                for(int i=2009;i<=(anneeEnCours+1);i++){
...
<form action="<%=lien%>?but=ded/apresModifLC.jsp" method="POST" name="frmListe" id="frmListe">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="monographe">
        ...
        <tr class="head">
          ...
          <td width="12%" height="19" valign="top"><div align="center"><strong>Credit </strong></div></td>
  ...
  %>
        <tr>
          <td align="left" valign="top"><input name="idLC" class="radio"  type='radio' value="<%=lcc[i].getIdLigne()%>"></td>
  ...
  %>
     ...
     <div align="center">
        ...
        <input type="hidden" name="idligne" value="<%=request.getParameter("idligne")%>">
        <input type="hidden" name="numFact" value="<%=request.getParameter("numFact")%>">
        <input type="hidden" name="num" value="<%=request.getParameter("num")%>">
        <input type="hidden" name="acte" value="update">
        <input type="hidden" name="ordre" value="or">
     </div>
   </form>
   <br />
   <!-- Pagination -->
