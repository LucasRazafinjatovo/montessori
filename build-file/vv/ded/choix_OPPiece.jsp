...
pr.setApres("ded/choix_OPPiece.jsp");
String colSomme[]={"montant"};
pr.setNpp(100);
pr.creerObjetPage(libEntete,colSomme);
OpTous []listeP=(OpTous [])pr.getRs().getResultat();
...
<form action="choix_OPPiece.jsp?champReturn=<%=request.getParameter("champReturn")%>" method="post" name="listeop" id="listeop">
<%
