...
<form action="listeArticleCommandeChoix.jsp?champReturn=<%=request.getParameter("champReturn")%>" method="post" name="listearticlecommandechoix" id="listearticlecommandechoix">
<%
