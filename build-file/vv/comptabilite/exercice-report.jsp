...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
			<td align="center">
			  <input name="acte" type="hidden" id="acte" value="reporter">
              <input type="submit" name="Submit" value="Reporter" class="submit">
			</td>
          <td align="center"><input type="reset" name="annuler" value="R&eacute;tablir" class="submit" /></td>
			 <input name="bute" type="hidden" id="bute" value="comptabilite/exercice-report.jsp">
  </tr>
</table>
    </td>
        </tr>
