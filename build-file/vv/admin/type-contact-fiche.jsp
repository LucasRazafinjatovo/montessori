<%-- 
    Document   : type-contact-fiche
    Created on : 26 janv. 2018, 09:34:07
    Author     : herinihaja
--%>
            ...
            <div class="box-fiche">
                <div class="box" style="margin-top:0px !important;">
                    <div class="box-footer">
                        <a href="<%=(String) session.getValue("lien")%>?id=<%=base.getId()%>&but=admin/typecontact-modif.jsp">Modifier</a>
                    </div>
                </div>
            </div>
        </div>
