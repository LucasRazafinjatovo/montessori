                    ...
                    <div id="selectnonee">
                        ...
                        <form method="POST" class="col-md-offset-3 col-md-6" action="<%=lien%>?but=admin/apresTarif.jsp">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th><label for="zone" tabindex="1">IdFactureClient:</label></th>
                                        <td>
                                            <input type="text" name="idFactureClient" />
                                            ...
                                            <input name="choix" class="submit" style="margin-left: 5px;" onclick="pagePopUp('ded/listeChoixFactureClient.jsp?champReturn=idFactureClient&apresLienPageAppel=admin/annulerFactureClient.jsp')" value="..." type="button">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="box-footer" style="display: block;">
                                <div class="row col-md-12">
                                    ...
                                    <input type="hidden" name="acte" value="annulerFacture">
