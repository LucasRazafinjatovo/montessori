...
//dev = u.findTva("%", "%","","");
       ...
       //bc=u.findFactureFournisseur("FACTURECLIENTLETTRE", idFact, "", "", "%","%","daty","asc", "");
...
<tr>
            <td width="35%" class="left">Num Facture Client  : </td>
...
<input name="idfactureclient" type="hidden" id="idfactureclient" value="<%=idFact%>">
   <input type="hidden" name="acte" value="viser" />
             &nbsp;
    <input type="submit" name="Submit" value="Jointure LC" class="submit"
 onClick="acte.value='vOP'">
 &nbsp;
 <input type="submit" name="Submit" value="Modifier" class="submit"
 onClick="acte.value='modifier'">
&nbsp;
<input type="submit" name="Submit" value="Att Pub" class="submit"
 onClick="acte.value='attP'">
<input type="submit" name="Submit" value="Att Dist" class="submit"
 onClick="acte.value='attDist'">
...
<input type="button" name="Submit" value="Viser" class="submit"
 onClick="parent.location='<%=lien%>?but=facturefournisseur/viserFactureRecette.jsp&numObjet=<%=idFact%>'">
<%//}
...
<h2><a href="<%=lien%>?but=facture/detailFacture.jsp&idFactureMere=<%=bc[0].getNumFact()%>">Details de la Facture Client</a> </h2>
<%}%>
    </td>
        </tr>
</table>
